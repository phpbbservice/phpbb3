...
$lang = array_merge($lang, array(
	...
	<br />
	Dit forum draait op phpBB. phpBB is een bulletinboard oplossing dat is uitgebracht onder de “<a href="http://opensource.org/licenses/gpl-2.0.php">GNU General Public License v2</a>” (hierna “GPL”) en kan gedownload worden via <a href="https://www.phpbb.com/">www.phpbb.com</a> en via de Nederlandstalige website <a href="http://www.phpbbservice.nl">www.phpbbservice.nl</a>. De phpBB software vergemakkelijkt alleen de internet gebaseerde discussies. De phpBB-groep is niet verantwoordelijk voor de inhoud en/of de houding van wat er is toegestaan en wat niet. Meer informatie over phpBB, kan je vinden op de volgende websites <a href="https://www.phpbb.com/">https://www.phpbb.com/</a> of de Nederlandstalige website <a href="http://www.phpbbservice.nl">www.phpbbservice.nl</a>.<br />
	<br />
	Je gaat akkoord met het volgende: geen kwetsende, obscene, vulgaire, lasterlijke, haatdragende, dreigende, seksueel georiënteerde of anderzijds verwerpelijke berichten te plaatsen, die de van toepassing zijnde regels en/of wetten schenden die gelden voor je land, het land waar “%1$s” is gehost of de internationale wetgeving. Het plaatsen van dergelijke berichten kan ertoe leiden dat u met onmiddelijke ingang en permanent wordt verbannen van dit forum. Tevens kan je serviceprovider worden ingelicht. De IP-aderessen van alle berichten worden opgeslagen om deze voorwaarden te kunnen waarborgen. Je gaat er mee akkoord dat “%1$s” het recht heeft om ieder onderwerp te verwijderen, te wijzigen, te sluiten of te verplaatsen wanneer zij dit nodig achten. Als gebruiker ga je ermee akkoord dat de informatie die je bij ons invoert, wordt opgeslagen in een database. Hoewel deze informatie niet aan een derde partij zal worden verstrekt zonder uw toestemming, kan “%1$s” noch phpBB niet verantwoordelijk worden gehouden voor een hackpoging die ertoe kan leiden dat de gegevens vrijkomen.
	',

	'PRIVACY_POLICY'		=> 'Dit beleid legt in detail uit hoe “%1$s” samen met zijn verbonden diensten en bedrijven (hierna “wij”, “ons”, “onze”, “%1$s”, “%2$s”) en phpBB (hierna “zij”, “hun”, “zijn”, “phpBB software”, “www.phpbb.com”, “http://www.phpbbservice.nl”, “phpBB Groep”, “phpBB Teams”) de informatie die wordt verzameld gedurende een bezoek aan dit forum, wordt gebruikt (hierna “je informatie”).<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM'						=> 'Sta gebruikers toe om je privé berichten te versturen',
	...
	'DELETE_MESSAGE_CONFIRM'	=> 'Weet je zeker dat je dit privé bericht wilt verwijderen?',
	...
	'DISABLE_CENSORS'			=> 'Woord censuur inschakelen',
	...
	'EMAIL_REMIND'				=> 'Dit moet het e-mailadres zijn dat geassocieerd wordt met je account. Als je dit niet veranderd hebt via je gebruikerscontrolepaneel dan is dit het e-mailadres waarmee je je geregistreerd hebt op dit forum.',
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Het veld “%2$s” is te kort, een minimum van %1$d karakter is vereist.',
		2	=> 'Het veld “%2$s” is te kort, een minimum van %1$d karakters is vereist.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Het veld “%2$s” is te lang, een maximum van %1$d karakter is toegestaan.',
		2	=> 'Het veld “%2$s” is te lang, een maximum van %1$d karakters is toegestaan.',
	),
	...
	'FOES_EXPLAIN'				=> 'Vijanden zijn gebruikers die standaard genegeerd zullen worden. Berichten door deze gebruikers zullen niet volledig zichtbaar zijn. Persoonlijke berichten van vijanden zijn nog steeds toegestaan. Let op dat je geen moderators of beheerders kan negeren.',
	...
	'LOGIN_EXPLAIN_UCP'			=> 'Meld je aan om toegang te krijgen tot het gebruikerscontrolepaneel.',
	...
	'MARKED_MESSAGE'				=> 'Gemarkeerde bericht',
	...
	'NOTIFICATION_TYPE_PM'								=> 'Iemand heeft een privé bericht verstuurd naar je',
	'NOTIFICATION_TYPE_POST'							=> 'Iemand heeft gereageerd op een onderwerp waarop je bent geabonneerd',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Iemand heeft je gequoteerd in een bericht',
	...
	'NOTIFY_ON_PM'					=> 'Notificeer me bij nieuwe privé berichten',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Je hebt momenteel %d privé bericht dat teruggehouden wordt vanwege een volle map.',
		2	=> 'Je hebt momenteel %d privé berichten die teruggehouden worden vanwege een volle map.',
	),
	'NO_ACTION_MODE'				=> 'Geen berichten actie gespecificeerd.',
	'NO_AUTHOR'						=> 'Geen auteur gedefinieerd voor dit bericht',
	'NO_AVATAR_CATEGORY'			=> 'Geen',

	'NO_AUTH_DELETE_MESSAGE'		=> 'Je mag geen privé berichten verwijderen.',
	'NO_AUTH_EDIT_MESSAGE'			=> 'Je mag geen privé berichten wijzigen.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'Je mag geen privé berichten doorsturen.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'Je mag geen privé berichten sturen naar groepen.',
	...
	'NO_AUTH_READ_HOLD_MESSAGE'		=> 'Je mag geen privé berichten lezen die teruggehouden worden.',
	'NO_AUTH_READ_MESSAGE'			=> 'Je mag geen privé berichten lezen.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'Je kan dit bericht niet lezen omdat deze is verwijderd door de auteur.',
	'NO_AUTH_SEND_MESSAGE'			=> 'Je mag geen privé berichten versturen.',
	...
	'NO_EDIT_READ_MESSAGE'		=> 'Privé bericht kan niet gewijzigd worden omdat het al gelezen is.',
	'NO_EMAIL_USER'				=> 'Het opgegeven e-mailadres/gebruikersnaam informatie kan niet gevonden worden.',
	'NO_FOES'					=> 'Geen vijanden momenteel gedefinieerd',
	'NO_FRIENDS'				=> 'Geen vrienden momenteel gedefinieerd',
	...
	'NO_IMPORTANT_NEWS'			=> 'Geen belangrijke mededelingen present.',
	'NO_MESSAGE'				=> 'Privé bericht kan niet gevonden worden.',
	...
	'NO_RULES_DEFINED'			=> 'Geen regels gedefinieerd.',
	'NO_SAVED_DRAFTS'			=> 'Geen concepten opgeslagen.',
	'NO_TO_RECIPIENT'			=> 'Geen',
	'NO_WATCHED_FORUMS'			=> 'Je bent niet geabonneerd op een forum.',
	'NO_WATCHED_SELECTED'		=> 'Je hebt geen geabonneerde onderwerpen of fora geselecteerd.',
	'NO_WATCHED_TOPICS'			=> 'Je bent niet geabonneerd op een onderwerp.',

	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Wachtwoord moet tussen %1$s en %2$s karakters lang zijn en moet gewone letters, hoofdletters en nummers bevatten.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Moet tussen %1$s en %2$s zijn.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Wachtwoord moet tussen de %1$s en %2$s karakters lang zijn en moet gewone en hoofdletters bevatten.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Wachtwoord moet tussen de %1$s en %2$s karakters lang zijn en moet gewone letters, hoofdletters, nummers en symbolen bevatten.',
	'PASSWORD'					=> 'Wachtwoord',
	...
	'PERMISSIONS_RESTORED'		=> 'Originele permissies succesvol hersteld.',
	...
	'PM_DISABLED'				=> 'Privé berichten zijn uitgeschakeld op dit forum.',
	'PM_FROM'					=> 'Van',
	...
	'POST_PM_LOCKED'			=> 'Privé berichten is gesloten.',
	'POST_PM_POST'				=> 'Quote bericht',
	'POST_QUOTE_PM'				=> 'Quote bericht',
	'POST_REPLY_PM'				=> 'Reageer op bericht',
	'PRINT_PM'					=> 'Print weergave',
	...
	'REPORT_PM'							=> 'Meld privé bericht',
	'RESIGN_SELECTED'					=> 'Zeg geselecteerde op',
	'RETURN_FOLDER'						=> '%1$sTerug naar vorige map%2$s',
	'RETURN_UCP'						=> '%sTerug naar gebruikerscontrolepaneel%s',
	'RULE_ADDED'						=> 'Regel succesvol toegevoegd.',
	'RULE_ALREADY_DEFINED'				=> 'Deze regel is de vorige keer al gedefinieerd.',
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> '%d privé bericht is verwijderd vanwege privé berichten filters.',
		2	=> '%d privé berichten zijn verwijderd vanwege privé berichten filters.',
	),
	...
	'UCP_AUTH_LINK_MANAGE'		=> 'Beheer externe account associaties',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Het koppelen van forumaccounts met externe services wordt niet ondersteund door dit forums authenticatie methode.',
	...
	'UCP_WELCOME'					=> 'Welkom in het gebruikerscontrolepaneel. Hier kan je je profiel, voorkeuren, geabonneerde fora en onderwerpen controleren, bekijken en bijwerken. Je kan ook berichten naar andere gebruikers versturen (indien toegestaan). Zorg er voor dat je iedere aankondiging leest voordat je doorgaat.',
	...
	'UPLOAD_AVATAR_URL_EXPLAIN'		=> 'Voer de URL van de locatie die de afbeelding bevatof . De afbeelding zal gekopieerd worden naar deze site.',
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Gebruikersnaam moet tussen de %1$s en %2$s karakters lang zijn en alleen uit alfanumerieke karakters bestaan.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Gebruikersnaam moet tussen de %1$s en %2$s karakters lang zijn en alleen uit alfanumerieke, spatie of -+_[] karakters bestaan.',
	'USERNAME_ASCII_EXPLAIN'en		=> 'Gebruikersnaam moet tussen de %1$s en %2$s karakters lang zijn en alleen uit ASCII karakters bestaan, dus geen speciale symbolen.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Gebruikersnaam moet tussen de %1$s en %2$s karakters lang zijn en alleen letters en cijfers bestaan.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Gebruikersnaam moet tussen de %1$s en %2$s karakters lang zijn en alleen uit letters, cijfers, spatie of -+_[] karakters bestaan.',
	...
	'WATCHED_EXPLAIN'			=> 'Hieronder is een lijst van fora en onderwerpen waarop je bent geabonneerd. Je zal op de hoogte gebracht worden van nieuwe berichten in beide. Om je abonnement op te heffen markeer het forum of onderwerp en druk op de <em>Gemarkeerde opzeggen</em> knop.',
	'WATCHED_FORUMS'			=> 'Geabonneerde fora',

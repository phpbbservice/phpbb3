...
$lang = array_merge($lang, array(
	...
	'ACP'							=> 'Beeheerderscontrolpepaneel',
	'ACP_SHORT'						=> 'Beheer',
	'ACTIVE'						=> 'actief',
	'ACTIVE_ERROR'					=> 'De gespecificeerde gebruikersnaam is momenteel inactief. Als je problemen hebt met het activeren van je account, neem dan contact op met een forumbeheerder.',
	...
	'AJAX_ERROR_TEXT_ABORT'			=> 'Aanvraag afgebroken door gebruiker.',
	...
	'AUTHOR'						=> 'Auteur',
	'AUTH_NO_PROFILE_CREATED'		=> 'Het aanmaken van een gebruikersprofiel was onsuccesvol.',
	...
	'AVATAR_DISALLOWED_CONTENT'		=> 'De upload was geweigerd omdat het geüploade bestand geïdentificeerd is als een mogelijke aanvalsvector.',
	'AVATAR_DISALLOWED_EXTENSION'	=> 'Dit bestand kan niet weergegeven worden omdat de extensie <strong>%s</strong> niet is toegestaan.',
	...
	'AVATAR_PARTIAL_UPLOAD'			=> 'Het gespecificeerde bestand is alleen gedeeltelijk geüpload.',
	...
	'AVATAR_PHP_SIZE_OVERRUN'		=> 'De avatar bestandsgrootte is te groot. De maximum toegestane bestandsgrootte is %1$d %2$s.<br />Let op: dit is ingesteld in de php.ini en kan niet omzeilt worden.',
	...
	'AVATAR_WRONG_FILESIZE'			=> 'De avatar bestandsgrootte moet tussen 0 en %1d %2s zijn.',
	...
	'BOARD_BAN_PERM'		=> 'Je bent <strong>permanent</strong> verbannen van dit forum.<br /><br />Neem contact op met de %2$sBeheerder%3$s voor meer informatie.',
	...
	'BUTTON_PM_REPLY'		=> 'Verstuur antwoord',
	'BUTTON_PM_REPLY_ALL'	=> 'Beantwoord allen',
	'BUTTON_POST_REPLY'		=> 'Plaats antwoord',
	'BUTTON_QUOTE'			=> 'Quote',
	...
	'CANCEL'				=> 'Annuleer',
	'CHANGE'				=> 'Verander',
	'CHANGE_FONT_SIZE'		=> 'Verander teken grootte',
	...
	'CONFIRM_CODE_EXPLAIN'	=> 'Voer de code exact zo in als het weergegeven wordt. Alle letters zijn hoofdletter gevoelig.',
	'CONFIRM_CODE_WRONG'	=> 'De bevestigingscode die je hebt ingevuld is niet correct.',
	'CONFIRM_OPERATION'		=> 'Weet je zeker dat je deze operatie wilt uitvoeren?',
	'CONGRATULATIONS'		=> 'Felicitaties aan',
	'CONNECTION_FAILED'		=> 'Verbinding verbroken.',
	'CONNECTION_SUCCESS'	=> 'Succesvol verbonden!',
	'COOKIES_DELETED'		=> 'Alle forum cookies succesvol verwijderd.',
	...
	'DELETE_COOKIES'		=> 'Verwijder alle forum cookies',
	...
	'DISPLAY_TOPICS'		=> 'Onderwerpen van vorige weergeven',
	...
	'EMPTY_SUBJECT'						=> 'Je moet een onderwerp specificeren wanneer je een nieuw onderwerp plaatst.',
	'EMPTY_MESSAGE_SUBJECT'				=> 'Je moet een onderwerp specificeren wanneer je een nieuw bericht opstelt.',
	...
	'ERR_TEMPLATE_EVENT_LOCATION'		=> 'De gespecificeerde sjabloon evenement locatie <em>[%s]</em> is niet goed geformateerd.',
	'ERR_TEMPLATE_COMPILATION'		=> 'Het bestand kon niet worden gecompileerd: %s',
	'ERR_UNABLE_TO_LOGIN'				=> 'De specifieke gebruikersnaam of wachtwoord is incorrect.',
	'ERR_UNWATCHING'					=> 'Een fout is opgetreden tijdens het opzeggen van het abonnement.',
	'ERR_WATCHING'						=> 'Een fout is opgetreden tijdens het aangaan van het abonnement.',
	'ERR_WRONG_PATH_TO_PHPBB'			=> 'De gespecificeerde phpBB pad lijkt ongeldig te zijn.',
	'ERROR'									=> 'Fout',
	...
	'FORUM'					=> 'Forum',
	'FORUMS'				=> 'Fora',
	'FORUMS_MARKED'			=> 'Fora zijn gemarkeerd als gelezen.',
	'FORUM_CAT'				=> 'Forumcategorie',
	'FORUM_INDEX'			=> 'Forumindex',
	'FORUM_LINK'			=> 'Forumkoppeling',
	...
	'FTP_FSOCK_PORT_EXPLAIN'		=> 'Port gebruikt om te verbinden met je server.',
	...
	'FTP_FSOCK_TIMEOUT_EXPLAIN'		=> 'De hoeveelheid tijd, in secondes, dat het systeem zal wachten op een antwoord van je server.',
	'FTP_FSOCK_USERNAME'			=> 'FTP gebruikersnaam',
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'Gebruikersnaam gebruikt om te verbinden met je server.',

	'FTP_HOST'					=> 'FTP host',
	'FTP_HOST_EXPLAIN'			=> 'FTP server die gebruikt wordt om te verbinden met je site.',
	'FTP_PASSWORD'				=> 'FTP wachtwoord',
	'FTP_PASSWORD_EXPLAIN'		=> 'Wachtwoord voor je FTP gebruikersnaam.',
	'FTP_PORT'					=> 'FTP port',
	'FTP_PORT_EXPLAIN'			=> 'Port gebruikt om te verbinden met je server.',
	'FTP_ROOT_PATH'				=> 'Pad naar phpBB',
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Pad van de bron naar je phpBB forum.',
	'FTP_TIMEOUT'				=> 'FTP time-out',
	'FTP_TIMEOUT_EXPLAIN'		=> 'De hoeveelheid tijd, in secondes, dat het systeem zal wachten op een antwoord van je server.',
	'FTP_USERNAME'				=> 'FTP gebruikersnaam',
	'FTP_USERNAME_EXPLAIN'		=> 'Gebruikersnaam gebruikt om te verbinden met je server.',
	...
	'GROUP'						=> 'Groep',
	'GROUPS'					=> 'Groepen',
	'GROUP_ERR_TYPE'			=> 'Ongeschikte groepstype gespecificeerd.',
	'GROUP_ERR_USERNAME'		=> 'Geen groepsnaam gespecificeerd.',
	'GROUP_ERR_USER_LONG'		=> 'Groepsnamen kunnen niet meer dan 60 karakters bevatten. De gespecificeerde groepsnaam is te lang.',
	'GUEST'						=> 'Gast',
	...
	'IMAGE_FILETYPE_MISMATCH'	=> 'Afbeelding bestandstype Image file type verkeerde combinatie: verwachte extensie %1$s maar extensie %2$s gegeven.',
	'IN'						=> 'in',
	'INDEX'						=> 'Indexpagina',
	'INFORMATION'				=> 'Informatie',
	'INSECURE_REDIRECT'			=> 'Geprobeerd door te sturen naar een potentieel onveilige url.',
	'INTERESTS'					=> 'Interesses',
	'INVALID_DIGEST_CHALLENGE'	=> 'Ongeldige verslag uitdaging.',
	'INVALID_EMAIL_LOG'			=> '<strong>%s</strong> is mogelijk een ongeldig e-mailadres?',
	'INVALID_PLURAL_RULE'		=> 'De gekozen meervoud regel is ongeldig. Geldige waardes zijn integers tussen  0 and 15.',
	'IP'						=> 'IP',
	...
	'JUMP_TO'				=> 'Spring naar',
	'JUMP_TO_PAGE'			=> 'Klik om te springen naar pagina…',
	...
	'LOGIN'								=> 'Aanmelden',
	'LOGIN_CHECK_PM'					=> 'Meld je aan om je privé berichten te controleren.',
	...
	'MARK_SUBFORUMS_READ'	=> 'Markeer subfora gelezen',
	'MB'					=> 'MB',
	'MIB'					=> 'MiB',
	'MCP'					=> 'Moderator Controlepaneel',
	'MCP_SHORT'				=> 'Modereer',
	'MEMBERLIST'			=> 'Leden',
	'MEMBERLIST_EXPLAIN'	=> 'Bekijk complete ledenlijst',
	'MERGE'					=> 'Samenvoegen',
	'MERGE_POSTS'			=> 'Verplaats berichten',
	...
	'NOTIFICATION_PM'					=> '%1$s heeft je een privé bericht "%2$s" gestuurd.',
	...
	'NOTIFICATION_TOPIC'				=> '%1$s heeft een nieuw onderwerp "%2$s" geplaatst in het forum "%3$s".',
	'NOTIFICATION_TOPIC_APPROVED'		=> 'Je onderwerp "%2$s" in forum "%3$s" is goedgekeurd.',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> 'Je onderwerp "%1$s" is afgekeurd om de volgende reden: "%2$s".',
	...
	'NO_ACTION'					=> 'Geen actie gespecificeerd.',
	'NO_ADMINISTRATORS'			=> 'Er zijn geen beheerders.',
	'NO_AUTH_ADMIN'				=> 'Toegang tot het beheerderspaneel is niet toegestaan als je geen administratieve permissies hebt.',
	'NO_AUTH_ADMIN_USER_DIFFER'	=> 'Je kan je niet als een andere gebruiker opnieuw waarmerken.',
	...
	'NO_FEED'					=> 'De gevraagde feed is niet beschikbaar.',
	'NO_STYLE_DATA'				=> 'Kan geen stijldata verkrijgen',
	'NO_SUBJECT'				=> 'Geen onderwerp gespecificeerd',								// Used for posts having no subject defined but displayed within management pages.
	'NO_SUCH_SEARCH_MODULE'		=> 'De gespecificeerde zoek-achtergrond bestaat niet.',
	...
	'NO_TOPICS_TIME_FRAME'		=> 'Er bestaan geen onderwerpen in dit forum voor de geselecteerde tijdsframe.',
	'NO_UNREAD_POSTS'			=> 'Geen ongelezen berichten',
	'NO_UPLOAD_FORM_FOUND'		=> 'Upload gestart maar geen geldig bestand upload formulier gevonden.',
	'NO_USER'					=> 'De opgevraagde gebruiker bestaat niet.',
	'NO_USERS'					=> 'De opgevraagde gebruikers bestaan niet.',
	'NO_USER_SPECIFIED'			=> 'Geen gebruikersnaam gespecificeerd.',
	...
	'POST_DELETED'			=> 'Verwijderd bericht:',
	...
	'POST_SUBJECT'			=> 'Berichten onderwerp',
	'POST_TIME'				=> 'Plaatsingstijd',
	'POST_TOPIC'			=> 'Plaats een nieuw onderwerp',
	'POST_UNAPPROVED'		=> 'Bericht wacht op goedkeuring:',
	'POWERED_BY'			=> 'Gemaakt door %s',
	'PREVIEW'				=> 'Voorbeeld',
	...
	'PRIVATE_MESSAGING'		=> 'Privé berichten',
	'PROFILE'				=> 'Gebruikers Controle Paneel',

	'RANK'						=> 'Rang',
	'READING_FORUM'				=> 'Bekijkt onderwerpen in %s',
	'READING_GLOBAL_ANNOUNCE'	=> 'Leest algemene aankondiging',
	'READING_LINK'				=> 'Volgt forumkoppeling %s',
	...
	'REMOVE'					=> 'Verwijder',
	'REMOVE_INSTALL'			=> 'Verwijder, verplaats of hernoem de install map voordat je je forum gaat gebruiken. Als deze map nog steeds aanwezig is, dan zal alleen het beheerderspaneel (ACP) toegankelijk zijn.',
	'REPLIES'					=> 'Reacties',
	...
	'SEARCHING_FORUMS'			=> 'Doorzoeken fora',
	...
	'SEARCH_SELF'				=> 'Bekijk je berichten',
	...
	'SEE_ALL'					=> 'Bekijk alle',
	'SELECT'					=> 'Selecteer',
	'SELECT_ALL_CODE'			=> 'Selecteer alle',
	'SELECT_DESTINATION_FORUM'	=> 'Selecteer een doel forum',
	'SELECT_FORUM'				=> 'Selecteer een forum',
	'SEND_EMAIL'				=> 'E-mail',				// Used for submit buttons
	'SEND_EMAIL_USER'			=> 'E-mail',				// Used as: {L_SEND_EMAIL_USER} {USERNAME} -> Email UserX
	'SEND_PRIVATE_MESSAGE'		=> 'Verstuur privé bericht',
	...
	'TOO_LONG_AIM'					=> 'De schermnaam die je hebt ingevuld is te lang.',
	'TOO_LONG_CONFIRM_CODE'			=> 'De bevestigingscode die je hebt ingevuld is te lang.',
	'TOO_LONG_DATEFORMAT'			=> 'De datumformaat die je hebt ingevuld is te lang.',
	'TOO_LONG_ICQ'					=> 'Het ICQ nummer dat je hebt ingevuld is te lang.',
	'TOO_LONG_INTERESTS'			=> 'De interesses die je hebt ingevuld zijn te lang.',
	'TOO_LONG_JABBER'				=> 'De Jabber accountnaam die je hebt ingevuld is te lang.',
	'TOO_LONG_LOCATION'				=> 'De locatie die je hebt ingevuld is te lang.',
	'TOO_LONG_MSN'					=> 'De WLM naam die je hebt ingevuld is te lang.',
	'TOO_LONG_NEW_PASSWORD'			=> 'Het wachtwoord die je hebt ingevuld is te lang.',
	'TOO_LONG_OCCUPATION'			=> 'Het beroep die je hebt ingevuld is te lang.',
	'TOO_LONG_PASSWORD_CONFIRM'		=> 'De wachtwoord bevestiging die je hebt ingevuld is te lang.',
	'TOO_LONG_USER_PASSWORD'		=> 'Het wachtwoord die je hebt ingevuld is te lang.',
	...
	'TOO_SHORT_ICQ'					=> 'Het ICQ nummer dat je hebt ingevuld is te kort.',
	'TOO_SHORT_INTERESTS'			=> 'De interesses die je hebt ingevuld zijn te kort.',
	'TOO_SHORT_JABBER'				=> 'De Jabber accountnaam die je hebt ingevuld is te kort.',
	'TOO_SHORT_LOCATION'			=> 'De locatie die je hebt ingevuld is te kort.',
	'TOO_SHORT_MSN'					=> 'De WLM naam die je hebt ingevuld is te kort.',
	'TOO_SHORT_NEW_PASSWORD'		=> 'Het wachtwoord die je hebt ingevuld is te kort.',
	'TOO_SHORT_OCCUPATION'			=> 'Het beroep die je hebt ingevuld is te kort.',
	'TOO_SHORT_PASSWORD_CONFIRM'	=> 'De wachtwoord bevestiging die je hebt ingevuld is te kort.',
	'TOO_SHORT_USER_PASSWORD'		=> 'Het wachtwoord die je hebt ingevuld is te kort.',
	...
	'TOO_SHORT_WEBSITE'				=> 'Het websiteadres die je hebt ingevuld is te kort.',
	'TOO_SHORT_YIM'					=> 'De Yahoo! Messenger naam die je hebt ingevuld is te kort.',
	...
	'TOTAL_PMS'		=> array(
		1	=> '%d privé bericht in totaal',
		2	=> '%d privé berichten in totaal',
	),
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Het spijt ons, maar je hebt geen toestemming om deze functie te gebruiken. Je bent misschien net geregistreerd en je zal dus wat meer moeten participeren om gebruik te kunnen maken van deze functie.',
	...
	'VIEWING_MCP'				=> 'Bekijkt moderator controle paneel',
	'VIEWING_MEMBER_PROFILE'	=> 'Bekijkt ledenprofiel',
	'VIEWING_PRIVATE_MESSAGES'	=> 'Bekijkt privé berichten',
	'VIEWING_REGISTER'			=> 'Registreert een account',
	'VIEWING_UCP'				=> 'Bekijkt gebruikers controle paneel',
	'VIEWS'						=> 'Weergaves',
	...
	'WRONG_DATA_ICQ'			=> 'Het nummer dat je hebt ingevuld is niet een geldig ICQ nummer.',
	...
	'WRONG_DATA_WEBSITE'		=> 'Het websiteadres moet een geldig url zijn, inclusief het protocol. Bijvoorbeeld http://www.voorbeeld.nl/.',
	'WROTE'						=> 'schreef',

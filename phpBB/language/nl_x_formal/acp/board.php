...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Dit zal het forum onbereikbaar maken voor gebruikers die geen beheerders of moderators zijn. U kunt ook een korte tekst van 255 tekens laten weergeven als u wenst.',
...
$lang = array_merge($lang, array(
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Voor geüploade avatar-bestanden. Als deze waarde 0 is, zal de maximale geüploade bestandsgrootte worden gebruikt die is opgegeven in uw PHP-configuratie.',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Aantal minuten, uren of dagen tussen het laatste bericht in een onderwerp en de mogelijkheid om het onderwerp opnieuw onder de aandacht te brengen. Door de waarde op 0 in te stellen schakelt u het omhooghalen van berichten volledig uit.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Wanneer u dit instelt op ja, en het berichtlimiet voor nieuwe leden is opgegeven, dan zullen de pas geregistreerde gebruikers niet alleen worden geplaatst in de <em>Pas geregistreerde gebruikers</em>groep, maar zal dit ook hun standaard groep worden. Dit kan handig zijn als u voor deze groep een standaard rang en/of avatar wilt toewijzen, de gebruikers in deze groep zullen dan automatisch de rang en/of avatar overnemen.',

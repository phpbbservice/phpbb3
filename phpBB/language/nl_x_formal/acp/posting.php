...
// Disallow Usernames 
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Hier kunt u controleren welke gebruikersnamen niet gebruikt mogen worden. Niet-toegestaande gebruikersnamen mogen een jokerteken (*) bevatten.',
	'ADD_DISALLOW_EXPLAIN'	=> 'U kunt een gebruikersnaam niet-toestaan doormiddel van een joker (*) te gebruiken zodat het overeenkomt met elk teken.',
	'ADD_DISALLOW_TITLE'	=> 'Een niet-toegestaande gebruikersnaam toevoegen',

	'DELETE_DISALLOW_EXPLAIN'	=> 'U kunt een niet-toegestaande gebruikersnaam verwijderen door de gebruikersnaam te selecteren van deze lijst en daarna op de versturen-knop te klikken.',
	'DELETE_DISALLOW_TITLE'		=> 'Een niet-toegestaande gebruikersnaam verwijderen',
	'DISALLOWED_ALREADY'		=> 'De naam die u heeft ingevoerd is al niet-toegestaan.',

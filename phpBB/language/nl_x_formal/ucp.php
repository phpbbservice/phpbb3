...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '
		Door het bezoeken van “%1$s”, gaat u automatisch akkoord met bepaalde voorwaarden.
		Kunt u niet akkoord gaan met deze voorwaarden, bezoek of gebruik “%1$s” dan niet langer. Beheerder(s) en moderator(en) hebben het recht om de voorwaarden op ieder moment te wijzigen. De gebruikers zullen hiervan zoveel mogelijk op de hoogte worden gehouden. Het is echter aan te raden om zelf de voorwaarden regelmatig te controleren op wijzigingen. Kunt u niet akkoord gaan met deze wijzigingen, maak dan niet langer gebruik van “%1$s”. Blijft u gebruik maken van “%1$s”, dan gaat u automatisch akkoord met de wijzigingen.<br />
		<br />
		Dit forum draait op phpBB. phpBB is een bulletinboard oplossing dat is uitgebracht onder de “<a href="http://opensource.org/licenses/gpl-license.php">General Public License</a>” (hierna “GPL”) en kan gedownload worden via <a href="https://www.phpbb.com/">www.phpBB.com</a> en via de Nederlandstalige website <a href="http://www.phpBBservice.nl/">www.phpBBservice.nl</a>. De phpBB-software vergemakkelijkt alleen de internet gebaseerde discussies. De phpBB-groep is niet verantwoordelijk voor de inhoud en/of de houding van wat er is toegestaan en wat niet. Meer informatie over phpBB, kunt u vinden op de volgende website; <a href="https://www.phpbb.com/">https://www.phpbb.com</a> of de Nederlandstalige website <a href="http://www.phpBBservice.nl/">http://www.phpBBservice.nl</a>.<br />
		<br />
...
$lang = array_merge($lang, array(
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'Dit bericht is verwijderd door de auteur.',
	'MESSAGE_SENT_ON'				=> 'op',
	...
	'RULE_LIMIT_REACHED'        		=> 'U heeft het maximum aantal regels bereikt. U kunt geen PB-regels meer toevoegen.',	

...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '
		Door het bezoeken van “%1$s”, ga je automatisch akkoord met bepaalde voorwaarden.
		Kan je niet akkoord gaan met deze voorwaarden, bezoek of gebruik “%1$s” dan niet langer. Beheerder(s) en moderator(en) hebben het recht om de voorwaarden op ieder moment te wijzigen.  De gebruikers zullen hiervan zoveel mogelijk op de hoogte worden gehouden. Het is echter aan te raden om zelf de voorwaarden regelmatig te controleren op wijzigingen. Kan u niet akkoord gaan met deze wijzigingen, maak dan niet langer gebruik van “%1$s”. Blijf je gebruik maken van “%1$s”, dan ga je automatisch akkoord met de wijzigingen.<br />
      	<br />
		...
		De IP-adressen van alle berichten worden opgeslagen om deze voorwaarden te kunnen waarborgen.
      	Je gaat ermee akkoord dat beheerder(s) en moderator(en) het recht hebben om onderwerpen te verwijderen te wijzigen te verplaatsen of te sluiten wanneer zij dit nodig achten. Als gebruiker ga je ermee akkoord dat de informatie die je bij ons invoert wordt opgeslagen in een database. Hoewel deze informatie niet aan een derde partij zal worden verstrekt zonder uw toestemming, kunnen beheerder(s) en moderator(en) of de phpBB-groep niet verantwoordelijk worden gehouden voor een hackpoging die ertoe kan leiden dat de gegevens vrijkomen.
    ',

	'PRIVACY_POLICY'	=> '
		Dit beleid legt in detail uit hoe “%1$s” samen met zijn verbonden diensten en bedrijven (hierna “wij”, “ons”, “onze”, “%1$s”, “%2$s”) en phpBB (hierna “zij”, “hun”, “zijn”, “phpBB software”, “www.phpBB.com”, “www.phpBBservice.nl”, “phpBB Groep”, “phpBB Teams”) de informatie die wordt verzameld gedurende een bezoek aan dit forum wordt gebruikt (hierna “jouw informatie”).<br />
		<br />
		Je informatie wordt op twee manieren verzameld. De eerste manier is door het gebruik van zogenaamde cookies. De phpBB software maakt meerdere cookies aan (kleine tekstbestanden die naar de tijdelijke internetbestanden van jouw computer worden gedownload). De eerste twee cookies bevat een identificatienummer (hierna "user-id") en een anonieme sessienummer (hierna "sessie-id"). Deze twee nummers worden automatisch door de phpBB software aan jou toegewezen. Een derde cookie zal worden aangemaakt wanneer je onderwerpen hebt gelezen op “%1$s”. Deze cookie wordt gebruikt om op te slaan welke onderwerpen er zijn gelezen, en verbeterd daarmee jouw gebruikerservaring.<br />
		<br />
		We kunnen ook cookies extern aanmaken aan de phpBB software wanneer u “%1$s” doorzoekt, Hoewel dit buiten dit document valt omdat dit geen betrekking heeft op de paginas die aangemaakt wordt door de phpBB software.
		De tweede manier is waarin wij uw informatie verzamelen is door wat u aan ons verstuurd. Dit kan zijn, en is niet beperkt naar: het plaatsen als een anonieme gebruiker (hierna “anonieme berichten”), registreren op “%1$s” (hierna “jouw account”) en berichten die geplaatst zijn na je registratie en wanneer je bent aangemeld (hierna “jouw berichten”).<br />
		<br />
		Je account bevat minstens een unieke identificeerbare naam (hierna “jouw gebruikersnaam”), een persoonlijk wachtwoord om te kunnen aanmelden op je account (hierna “jouw wachtwoord”) en een persoonlijk, geldige e-mailadres (hierna “jouw email”). Je informatie voor je account op “%1$s” is beveiligd door gegevensbeschermingswetgeving dat geldt in het land waar dit forum gehost is. Enige informatie naast je gebruikersnaam, je wachtwoord en je e-mailadres dat vereist is gedurend het registratieproces op “%1$s”  is niet vereist maar is optioneel. Je hebt de optie welke informatie in je account openbaar kan worden weergegeven. Verder heb je ook de mogelijkheid, om in te stellen of je de e-mails die automatisch worden gemaakt door de phpBB software wilt ontvangen.<br />
		<br />
		Je wachtwoord is versleuteld (en kan niet ontsleuteld gemaakt worden), waardoor het op een veilige manier is opgeslagen. Desondanks is het niet aan te raden dat je hetzelfde wachtwoord gebruikt op diverse websites. Jouw wachtwoord is het middel waarmee je op je account op “%1$s” kan aanmelden, bewaar het dus veilig en geef het op geen enkele manier aan “%1$s”, phpBB of een andere derde partij. Als je het wachtwoord van je account zou vergeten, kan je de “Ik heb mijn wachtwoord vergeten” optie gebruiken die je terug kan vinden in het aanmeldvenster. Dit proces vereist dat je de gebruikersnaam en e-mailadres opgeeft van je gebruikersaccoun, waarna de phpBB software een nieuw wachtwoord zal genereren zodat je opnieuw kan aanmelden.<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ACTIVE_PROFILE'		=> 'Je account is nu succesvol gereactiveerd.',
	'ACCOUNT_ADDED'					=> 'Bedankt voor het registreren, je account is aangemaakt. Je mag je nu aanmelden met je gebruikersnaam en wachtwoord.',
	'ACCOUNT_COPPA'					=> 'Je account is aangemaakt, maar deze moet nog goedgekeurd worden, bekijk je e-mail voor verdere details.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Je account is bijgewerkt. Dit forum vereist heractivatie van een account bij e-mail wijzigingen. Een activatiecode is verzonden naar je nieuwe e-mailadres dat je hebt opgegeven. Bekijk je e-mail voor verdere informatie.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Je account is bijgewerkt. Dit forum vereist heractivatie van een account door een beheerder bij e-mail wijzigingen. Een e-mail is verzonden naar hun, en je zal worden geïnformeerd wanneer je account is geheractiveerd.',
	'ACCOUNT_INACTIVE'				=> 'Je account is aangemaakt. Dit forum vereist activatie van een account, een activatiecode is verzonden naar het e-mailadres dat je hebt opgegeven. Bekijk je e-mail voor verdere informatie.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Je account is aangemaakt. Dit forum vereist activatie van een account door de beheerders. Een e-mail is verzonden naar hun, en je zal worden geïnformeerd wanneer je account is geheractiveerd.',
	...
	'ADD_FOES_EXPLAIN'				=> 'Je kan meerdere gebruikersnamen opgeven door ze elk op een aparte regel te plaatsen.',
	'ADD_FOLDER'					=> 'Nieuwe map aanmaken',
	'ADD_FRIENDS'					=> 'Vrienden toevoegen',
	'ADD_FRIENDS_EXPLAIN'			=> 'Je kan meerdere gebruikersnamen opgeven door ze elk op een aparte regel te plaatsen.',
	'ADD_NEW_RULE'					=> 'Nieuwe regel toevoegen',
	'ADD_RULE'						=> 'Regel toevoegen',
	'ADD_TO'						=> '[Naar] toevoegen',
	'ADD_USERS_UCP_EXPLAIN'			=> 'Hier kan je nieuwe gebruikers toevoegen aan de groep. Je kan selecteren of deze groep de nieuwe standaard groep wordt van de geselecteerde gebruikers. Vul iedere gebruikersnaam in op een nieuwe regel.',
	'ADMIN_EMAIL'					=> 'Beheerders kunnen mij informatie mailen',
	'AGREE'							=> 'Ik accepteer deze voorwaarden',
	'ALLOW_PM'						=> 'Sta toe dat gebruikers je privéberichten kunnen sturen',
	'ALLOW_PM_EXPLAIN'				=> 'Vergeet niet dat beheerders en moderators altijd in staat zijn om je privéberichten te sturen.',
	'ALREADY_ACTIVATED'				=> 'Je hebt je gebruikersaccount al geactiveerd',
	'ATTACHMENTS_EXPLAIN'			=> 'Dit is een lijst van bijlagen die jij hebt geplaatst in berichten op dit forum.',
	...
	'AVATAR_NOT_ALLOWED'			=> 'Je avatar kon niet worden weergegeven omdat avatars niet zijn toegestaan.',
	'AVATAR_PAGE'					=> 'Pagina',
	...
	'BIRTHDAY'					=> 'Verjaardag',
	'BIRTHDAY_EXPLAIN'			=> 'Wanneer je je geboortedatum invoert, zal het op de forumindex worden weergegeven wanneer je jarig bent.',
	...
	'BOOKMARKS_EXPLAIN'			=> 'Je kan onderwerpen toevoegen als een bladwijzer, zodat je ze later terug kan vinden. Wanneer je een bladwijzer wilt verwijderen, vink je het vakje aan, en druk je op de  <em>verwijder gemarkeerde bladwijzers</em> knop.',
	'BOOKMARKS_DISABLED'		=> 'Bladwijzers zijn uitgeschakeld op dit forum',
	'BOOKMARKS_REMOVED'			=> 'Bladwijzers zijn succesvol verwijderd',

	'CANNOT_EDIT_MESSAGE_TIME'	=> 'Je kan niet langer dit bericht wijzigen of verwijderen',
	'CANNOT_MOVE_TO_SAME_FOLDER'=> 'Berichten kunnen nier worden verplaats naar de map die je wilt verwijderen.',
	...
	'CONFIRM_EMAIL_EXPLAIN'		=> 'Je hoeft dit alleen in te vullen als je bezig bent om jouw e-mailadres te veranderen.',
	'CONFIRM_EXPLAIN'			=> 'Om automatische registraties tegen te gaan vereist de forumbeheerder dat je een bevestigingscode invoert. De code is weergegeven in de afbeelding die je hier onder zou moeten zien. Als je visuele beperkingen hebt of je kan deze code niet lezen, neem dan contact op de de %sforumbeheerder%s.',
	...
	'CONFIRM_PASSWORD_EXPLAIN'	=> 'Je hoeft alleen je wachtwoord te bevestigen als je het hierboven hebt veranderd.',
	...
	'COPPA_EXPLAIN'				=> 'Let op, wanneer je op versturen klikt zal jouw account worden aangemaakt. Alhoewel het kan niet worden geactiveerd totdat een ouder of een voogd de registratie heeft goedkeurd. Er zal een kopie van het benodigde formulier met de benodige informatie, waar je het heen moet sturen, naar de opgegeven e-mailadres worden verstuurd.',
	'CREATE_FOLDER'				=> 'Map aanmaken',
	'CURRENT_IMAGE'				=> 'Huidige afbeelding',
	'CURRENT_PASSWORD'			=> 'Huidige wachtwoord',
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Je moet je huidige wachtwoord bevestigen als je het wilt veranderen, of als je jouw e-mailadres of gebruikersnaam hebt gewijzigd.',
	'CUR_PASSWORD_EMPTY'		=> 'Je hebt niet je huidige wachtwoord ingevoerd.',
	'CUR_PASSWORD_ERROR'		=> 'Het huidige wachtwoord dat je hebt ingevoerd is onjuist.',
	...
	'DELETE_COOKIES_CONFIRM'	=> 'Weet je zeker dat je alle cookies die zijn ingesteld door dit forum wilt verwijderen?',
	...
	'DRAFTS_EXPLAIN'			=> 'Hier kan je de opgeslagen conceptberichten bekijken, wijzigen en verwijderen.',
	'DRAFT_UPDATED'				=> 'Conceptbericht succesvol bijgewerkt.',

	'EDIT_DRAFT_EXPLAIN'		=> 'Hier ben je in de gelegenheid om je conceptbericht te wijzigen. Conceptberichten bevatten geen bijlagen of peilingen.',
	'EMAIL_BANNED_EMAIL'		=> 'Het e-mailadres wat je hebt ingevoerd is niet toegestaan om te gebruiken.',
	'EMAIL_INVALID_EMAIL'		=> 'Het e-mailadres wat je hebt ingevoerd is ongeldig.',
	'EMAIL_REMIND'				=> 'Dit moet het e-mailadres zijn die is geassocieerd met je account. Als je dit niet hebt veranderd via je gebruikerspaneel, dan is dit het e-mailadres waarmee je jouw account hebt geregistreerd.',
	'EMAIL_TAKEN_EMAIL'			=> 'Het ingevoerde e-mailadres is al ingebruik',
	'EMPTY_DRAFT'				=> 'Je moet een bericht invoeren om je veranderingen te kunnen versturen.',
	...
	'FOES_EXPLAIN'				=> 'Vijanden zijn gebruikers die standaard worden genegeerd. Berichten van deze gebruikers worden niet volledig weergegeven. Privéberichten van vijanden zijn nog steeds toegestaan. Vergeet niet dat je geen moderators of beheerders kan negeren.',
	...
	'FORCE_PASSWORD_EXPLAIN'	=> 'Voordat je verder dit forum mag doorzoeken, is het nodig dat je je wachtwoord veranderd.',
	'FRIEND_MESSAGE'			=> 'Bericht van vriend',
	'FRIENDS'					=> 'Vrienden',
	'FRIENDS_EXPLAIN'			=> 'Via vrienden kan je snel gebruikers vinden waarmee je regelmatig communiceert. Als de template het ondersteunt kunnen berichten extra opvallend zijn die geplaatst zijn door een vriend.',
	...
	'HIDE_ONLINE_EXPLAIN'		=> 'Het wijzigen van deze instelling zal pas effect hebben bij je volgende bezoek aan het forum.',
	...
	'INVALID_CHARS_USERNAME'	=> 'De gebruikersnaam bevat niet-toegestaande tekens.',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN' => 'Voer de URL in van de locatie van de avatar-afbeelding die je wenst te gebruiken.',
	...
	'LOGIN_EXPLAIN_UCP'			 => 'Meld je aan om toegang te verkrijgen tot het gebruikerspaneel.',
	'LOGIN_REDIRECT'			 => 'Je bent succesvol aangemeld.',
	'LOGOUT_FAILED'				 => 'Je bent niet afgemeld, aangezien de aanvraag niet overeen kwam met je sessie. Als het probleem zich blijft voordoen, neem dan contact op met de beheerder.',
	...
	'NEW_EMAIL_CONFIRM_EMPTY'		=> 'Je hebt niet het bevestigings-e-mailadres opgegeven.',
	'NEW_EMAIL_ERROR'				=> 'Het e-mailadres dat je hebt ingevoerd komt niet overeen.',
	'NEW_FOLDER_NAME'				=> 'Nieuwe mapnaam',
	'NEW_PASSWORD'					=> 'Nieuw wachtwoord',
	'NEW_PASSWORD_CONFIRM_EMPTY'	=> 'Je hebt niet een bevestigingswachtwoord opgegeven.',
	...
	'NOT_ADDED_FRIENDS_ANONYMOUS'	=> 'Je kan geen gastgebruiker toevoegen aan je vriendenlijst.',
	'NOT_ADDED_FRIENDS_BOTS'		=> 'Je kan geen zoekrobots toevoegen aan je vriendenlijst.',
	'NOT_ADDED_FRIENDS_FOES'		=> 'Je kan geen gebruikers toevoegen aan je vriendenlijst die al zijn toegevoegd aan je vijandenlijst.',
	'NOT_ADDED_FRIENDS_SELF'		=> 'Je kan jezelf niet toevoegen aan je vriendenlijst.',
	'NOT_ADDED_FOES_MOD_ADMIN'		=> 'Je kan geen beheerders en moderators toevoegen aan je vijandenlijst.',
	'NOT_ADDED_FOES_ANONYMOUS'		=> 'Je kan geen gastgebruiker toevoegen aan je vijandenlijst.',
	'NOT_ADDED_FOES_BOTS'			=> 'Je kan geen zoekrobots toevoegen aan je vijandenlijst.',
	'NOT_ADDED_FOES_FRIENDS'		=> 'Je kan geen gebruikers toevoegen aan je vijandenlijst die al zijn toegevoegd aan je vriendenlijst.',
	'NOT_ADDED_FOES_SELF'			=> 'Je kan jezelf niet toevoegen aan de vijandenlijst.',
	...
	'NOT_MOVED_MESSAGE'				=> 'Je hebt 1 privébericht die momenteel in de wachtrij staat, omdat er een map vol is.',
	'NOT_MOVED_MESSAGES'			=> 'Je hebt %d privéberichten die momenteel in de wachtrij staan, omdat er een map vol is.',
	...
	'NO_AUTH_DELETE_MESSAGE'		=> 'Je bent niet bevoegd om privéberichten te verwijderen.',
	'NO_AUTH_EDIT_MESSAGE'			=> 'Je bent niet bevoegd om privéberichten te wijzigen.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'Je bent niet bevoegd om privéberichten door te sturen.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'Je bent niet bevoegd om privéberichten te versturen naar groepen.',
	'NO_AUTH_PASSWORD_REMINDER'		=> 'Je bent niet bevoegd om een nieuw wachtwoord aan te vragen.',
	'NO_AUTH_READ_HOLD_MESSAGE'		=> 'Je bent niet bevoegd om privéberichten te lezen die in de wachtrij staan.',
	'NO_AUTH_READ_MESSAGE'			=> 'Je bent niet bevoegd om privéberichten te lezen.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'Je kan dit bericht niet meer lezen omdat het is verwijderd door de auteur.',
	'NO_AUTH_SEND_MESSAGE'			=> 'Je bent niet bevoegd om privéberichten te versturen.',
	'NO_AUTH_SIGNATURE'				=> 'Je bent niet bevoegd om een onderschrift in te voeren.',
	...
	'NO_NEWER_PM'				=> 'Er zijn geen nieuwer berichten.',
	'NO_OLDER_PM'				=> 'Er zijn geen oudere berichten.',
	'NO_PASSWORD_SUPPLIED'		=> 'Je kan je niet aanmelden zonder wachtwoord.',
	...
	'NO_WATCHED_FORUMS'			=> 'Je volgt geen forum.', //You are not subscribed to any forums. subscribe is inschrijven. // Je bent niet ingeschreven op een forum???
	'NO_WATCHED_SELECTED'		=> 'Je hebt geen forums of onderwerpen geselecteerd die je wilt volgen.', //You have not selected any subscribed topics or forums.
	'NO_WATCHED_TOPICS'			=> 'Je volgt geen onderwerpen.', //You are not subscribed to any topics.
	...
	'PASSWORD_UPDATED'			=> 'Een nieuw wachtwoord is verzonden naar jouw geregistreerde e-mailadres.',
	'PERMISSIONS_RESTORED'		=> 'Permissies zijn succesvol hersteld.',
	'PERMISSIONS_TRANSFERRED'	=> 'Permissies van <strong>%s</strong> zijn succevol overgebracht. Je kan nu door het forum navigeren met de permissies van deze gebruiker.<br />Let op, beheerderspermissies zijn niet overgebracht. Je kan altijd terugkeren naar je eigen permissies.',
	...
	'PM_INBOX'					=> 'Postvak IN',
	'PM_NO_USERS'				=> 'De gebruikers die je wilt toevoegen bestaan niet.',
	...
	'SAME_PASSWORD_ERROR'		=> 'Het nieuwe wachtwoord wat je hebt opgegeven is gelijk aan het huidige wachtwoord.',
	...
	'SIGNATURE_EXPLAIN'			=> 'Dit is een stukje tekst, of een afbeelding wat toegevoegd wordt aan elk bericht dat je plaatst. Er is een %d tekenlimiet',
	'SIGNATURE_PREVIEW'			=> 'Je onderschrift zal er zo uit komen te zien in berichten',
	...
	'TIMEZONE'					=> 'Tijdzone',
	'TO'						=> 'Naar',
	'TOO_MANY_RECIPIENTS'       => 'Je hebt geprobeerd een privébericht te versturen naar te veel ontvangers.',
	'TOO_MANY_REGISTERS'		=> 'Je hebt het maximaal aantal registratiepogingen voor deze sessie overschreden. Probeer het later nog eens.',

	'UCP'						=> 'Gebruikerspaneel',
	'UCP_ACTIVATE'				=> 'Account activeren',
	'UCP_ADMIN_ACTIVATE'		=> 'Je moet een werkend e-mailadres invoeren voor je account wordt geactiveerd. De beheerder zal je account beoordelen en bij goedkeuring zal je een e-mailbericht ontvangen op het door jouw opgegeven e-mailadres.',
	'UCP_AIM'					=> 'AOL Instant Messenger',
	'UCP_ATTACHMENTS'			=> 'Bijlagen',
	'UCP_COPPA_BEFORE'			=> 'Voor %s',
	'UCP_COPPA_ON_AFTER'		=> 'Op of later %s',
	'UCP_EMAIL_ACTIVATE'		=> 'Je moet een werkend e-mailadres invoeren voor je account wordt geactiveerd. Je zal een e-mailbericht ontvangen op het door jouw opgegeven e-mailadres dat een account activatielink bevat.',
	'UCP_ICQ'					=> 'ICQ-nummer',
	...
	'UCP_WELCOME'							=> 'Welkom in het gebruikerspaneel. Vanuit hier kan je je profiel volgen, bekijken en bijwerken, voorkeuren opgeven en forums en onderwerpen volgen. Je kan ook berichten versturen naar andere gebruikers (als dit is toegestaan). Maar vergeet niet voordat je verder gaat de mededelingen eventjes door te lezen.',
	...
	'UPLOAD_AVATAR_FILE'					=> 'Upload vanaf je computer',
	...
	'USERNAME_TAKEN_USERNAME'				=> 'De gebruikersnaam die je hebt ingevoerd is al in gebruik, kies een alternatieve.',
	'USERNAME_DISALLOWED_USERNAME'			=> 'De gebruikersnaam die je hebt ingevoerd is niet toegestaan, of bevatten niet toegestaande woorden. Kies een andere gebruikersnaam.',
	'USER_NOT_FOUND_OR_INACTIVE'			=> 'De gebruikersnaam die je hebt opgegeven kon niet worden gevonden, of is een niet geactiveerde gebruiker.',
	...
	'WATCHED_EXPLAIN'			=> 'Hieronder is de lijst van forums en onderwerpen waarop je geabonneerd bent. Je krijgt een e-mailbericht toegestuurd wanneer er een nieuw bericht is. Om het abonnement op te zeggen, markeer je het forum of onderwerp, en klik je op de <em>Abonnement opzeggen</em> knop.',
	'WATCHED_FORUMS'			=> 'Forums met abonnement',
	'WATCHED_TOPICS'			=> 'Onderwerpen met abonnement',
	'WRONG_ACTIVATION'			=> 'De activatiesleutel die je hebt opgegeven kan niet in de database worden gevonden.',

	'YOUR_DETAILS'				=> 'Je activiteit',
	'YOUR_FOES'					=> 'Je vijanden',
	'YOUR_FOES_EXPLAIN'			=> 'Om gebruikersnamen te verwijderen, selecteer je ze en klik je op versturen.',
	'YOUR_FRIENDS'				=> 'Je vrienden',
	'YOUR_FRIENDS_EXPLAIN'		=> 'Om gebruikersnamen te verwijderen, selecteer je ze en klik je op versturen.',
    ...
    'GROUPS_EXPLAIN'	=> 'Gebruikersgroepen maken het het voor forumbeheerders gemakkelijker om gebruikers te beheren. Standaard zal je worden geplaatst in een specifieke groep, dit is jouw standaardgroep. Deze groep bepaald hoe je overkomt naar andere gebruikers, bijvoorbeeld de kleur van je gebruikersnaam, avatar, rang, etc. Afhankelijk of de beheerder het toestaat, mag je jouw standaardgroep wijzigen. Je kan ook worden geplaatst in andere groepen of je kan lid worden van andere groepen mits het is toegestaan. Sommige groepen kunnen je extra permissies geven om inhoud te bekijken of jouw capaciteiten te vergroten in andere gebieden.',

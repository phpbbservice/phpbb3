...
$lang = array_merge($lang, array(
	...
	'ACP_DISALLOW_USERNAMES'	=> 'Niet-toegestaande gebruikersnamen',
	...
	'DOWNLOAD_STORE_EXPLAIN'	=> 'Je mag het bestand direct downloaden of het opslaan in jouw <samp>store/</samp> map.',
	...
	'LOGIN_ADMIN'			=> 'Om dit forum te beheren moet je een aangemelde gebruiker zijn.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Om dit forum te beheren moet je jezelf opnieuw aanmelden.',
	'LOGIN_ADMIN_SUCCESS'	=> 'Je bent succesvol aangemeld en je zal nu worden doorgestuurd naar het beheerderspaneel.',
	...
	'NOTIFY'				=> 'Notificatie',
	'NO_ADMIN'				=> 'Je bent niet bevoegd om dit forum te beheren.',
	'NO_EMAILS_DEFINED'		=> 'Er zijn geen geldige e-mailadressen gevonden.',
	'NO_PASSWORD_SUPPLIED'	=> 'Je moet je wachtwoord invullen om toegang te krijgen tot het beheerderspaneel.',
	...
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> 'Je hebt momenteel de permissies van %1$s. Je kan het forum doorzoeken met de permissies van deze gebruiker, maar je hebt geen toegang tot het beheerderspaneel aangezien beheerderspermissies niet zijn gekopiëerd. Je kan de <a href="%2$s"><strong>permissies herstellen op elk ogenblik naar jouw eigen permissies</strong></a>.',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> 'Deze pagina weergeeft informatie over de geïnstalleerde PHP-versie op deze server. Het weergeeft onder andere de standaardinstellingen, geladen modules en beschikbare variabelen. Deze informatie kan handig zijn als je een probleem wilt achterhalen. Vergeet niet dat sommige hosting bedrijven, een limiet kunnen hebben om bepaalde informatie te kunnen weergeven i.v.m. veiligheidsredenen. We raden aan om niet iedereen de informatie te geven, tenzij het gevraagd wordt door één van de <a href="http://over.phpbbservice.nl/team/">phpBBservice.nl teamleden</a> op de supportforums.',

	'NO_PHPINFO_AVAILABLE'	=> 'Informatie over jouw PHP-configuratie kan niet worden verkregen. phpinfo() is uitgeschakeld i.v.m. veiligheidsredenen.',
));

// Logs
$lang = array_merge($lang, array(
	'ACP_ADMIN_LOGS_EXPLAIN'	=> 'Dit weergeeft alle acties die zijn uitgevoerd door forumbeheerders. Je kan ze sorteren op gebruikersnaam, datum IP-adres of actie. Als je de juiste permissies hebt kan je een individuele log verwijderen of heel het logboek.',
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'Dit weergeeft alle acties die zijn uitgevoerd door het forum zelf. Dit logboek voorziet je van informatie zodat je in staat bent om specifieke problemen op te kunnen lossen, bijvoorbeeld niet afgeleverde e-mailberichten. Je kan ze sorteren op gebruikersnaam, datum IP-adres of actie. Als je de juiste permissies hebt kan je een individuele log verwijderen of heel het logboek.',
	'ACP_MOD_LOGS_EXPLAIN'		=> 'Dit weergeeft alle acties die zijn gedaan op forums, onderwerpen en berichten en ook de acties die zijn uitgevoerd op gebruikers door moderators, inclusief verbanningen. Je kan ze sorteren op gebruikersnaam, datum IP-adres of actie. Als je de juiste permissies hebt kan je een individuele log verwijderen of heel het logboek.',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Bedankt dat je hebt gekozen voor phpBB als forumsysteem. Dit scherm geeft je een snel overzicht over alle diverse statistieken van jouw forum. De links aan de linkerkant van dit scherm geven je de mogelijkheden om elk onderdeel te beheren van je forum. Elke pagina zal instructies bevatten over hoe je de hulpmiddelen kan gebruiken.',
	'ADMIN_LOG'					=> 'Gelogde beheerdersacties',
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'Dit geeft je een overzicht van de laatste vijf acties die zijn uitgevoerd door forumbeheerders. Een volledige kopie van de log kan worden bekeken in het juist menu of door op de volgende link hieronder te klikken.',
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD_EXPLAIN'        	=> '<var>mbstring.func_overload</var> moet worden ingesteld op 0 of 4. Je kan de huidige waarde op de <samp>PHP-informatie</samp> pagina controleren.',
	'ERROR_MBSTRING_ENCODING_TRANSLATION'         	=> 'De tekens bij de vertalingscodering is onjuist geconfigureerd',
	'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'   => '<var>mbstring.encoding_translation</var> moet worden ingesteld op 0. Je kan de huidige waarde op de <samp>PHP-informatie</samp> pagina controleren.',
	'ERROR_MBSTRING_HTTP_INPUT'                  	=> 'De tekens conversie van de HTTP-input is onjuist geconfigureerd',
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'            	=> '<var>mbstring.http_input</var> moet worden ingesteld op <samp>pass</samp>. Je kan de huidige waarde op de <samp>PHP-informatie</samp> pagina controleren.',
	'ERROR_MBSTRING_HTTP_OUTPUT'               		=> 'De tekens conversie van de HTTP-output is onjuist geconfigureerd',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'         	=> '<var>mbstring.http_output</var> moet worden ingesteld op <samp>pass</samp>. Je kan de huidige waarde op de <samp>PHP-informatie</samp> pagina controleren.',
	...
	'PURGE_SESSIONS_CONFIRM'	=> 'Weet je zeker dat je alle sessies wilt legen? Dit zorgt ervoor dat alle gebruikers worden afgemeld.',
	...
	'RESET_ONLINE_CONFIRM'			=> 'Weet je zeker dat je de meeste gebruikers tegelijkertijd online teller wilt resetten?',
	...
	'RESYNC_POSTCOUNTS_CONFIRM'		=> 'Weet je zeker dat je de berichtentellers wilt hersynchroniseren?',
	'RESYNC_POST_MARKING'			=> 'Gestipte onderwerpen hersychroniseren',
	'RESYNC_POST_MARKING_CONFIRM'	=> 'Weet je zeker dat je de gestipte onderwerpen wilt hersynchroniseren?',
	...
	'RESYNC_STATS_CONFIRM'			=> 'Weet je zeker dat je de statistieken wilt hersynchroniseren?',
	...
	'WRITABLE_CONFIG'		=> 'Je config bestand ( config.php ) is momenteel wereld-beschijfbaar. We raden je aan om de permissies te veranderen naar 640 of tenminste naar 644 (voor een voorbeeld: <a href="http://www.whelp.nl/2007/05/21/chmod-bestandsrechten/" rel="external">chmod</a> 640 config.php).',
));
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Dit is een lijst met de laatste 10 geregisteerde gebruikers die inactieve accounts hebben. Een volledige lijst is beschikbaar in het juiste menu of door de link hieronder te klikken waar deze gebruikers kan activeren, verwijderen of een herinnering sturen (doormiddel van een e-mail).',
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'Hier kan je informatie versturen over jouw server en forumconfiguratie naar phpBB voor een statische analyse. Alle informatie die jouw of jouw website kan identificeren zal worden verwijderd - de data is volledig <strong>anoniem</strong>. We baseren beslissingen over de toekomst van phpBB-versies op deze informatie. De statistieken zullen publiekelijk beschikbaar zijn. We zullen ook deze data delen met het PHP-project, de programmeertaal waar phpBB gemaakt mee is.',
	'EXPLAIN_SHOW_STATISTICS'	=> 'Door de knop hier onder te gebruiken, zie je een voorbeeld van alle variabelen die zullen worden verstuurd.',
	'DONT_SEND_STATISTICS'		=> 'Ga terug naar het beheerderspaneel, als je niet wenst om statische informatie naar phpBB te versturen.',
	...
	'THANKS_SEND_STATISTICS'	=> 'Dank je wel voor het versturen van jouw informatie.',
));

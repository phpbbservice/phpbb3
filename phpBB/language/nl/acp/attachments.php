...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'Hier kan je de hoofdinstellingen voor bijlagen en de speciale categorieën configureren.',
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Hier kan je extensiegroepen toevoegen, verwijderen, wijzigen of uitschakelen. Met de overige opties kan je een speciale categorie eraan toevoegen, het download-mechanisme veranderen, en een upload-pictogram opgeven dat weergegeven wordt voor de bijlagen die bij de desbetreffende groep horen.',
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'		=> 'Hier kan je alle toegestaande extenties beheren. Om de extenties te activeren ga je naar het beheerderspaneel van de extentiegroepen. We raden je streng aan om geen script-extentsies toe te staan (zoals <code>php</code>, <code>php3</code>, <code>php4</code>, <code>phtml</code>, <code>pl</code>, <code>cgi</code>, <code>py</code>, <code>rb</code>, <code>asp</code>, <code>aspx</code>, enzovoort…).',
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Hier kan je berichtloze bestanden zien. Dit gebeurt meestal als gebruikers bezig zijn met het toevoegen van bestanden, maar ze plaatsen het bericht nog niet. Hier kan je deze bestanden verwijderen of je kan ze toevoegen aan bestaande berichten. Voor het toevoegen aan berichten heb je wel een geldig bericht-ID nodig, je moet dit ID zelf bepalen. Dit zorgt er voor dat de bestaande geüploade bijlagen wordt toegevoegd aan het bericht dat je hebt opgegeven.',
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Maximale grootte van elk bestand. Als deze waarde 0 is, zal de maximale geüploade bestandsgrootte worden gebruikt die is opgegeven in je PHP-configuratie.',
	...
	'CHECK_CONTENT_EXPLAIN'		=> 'Sommige browsers kunnen worden beetgenomen, zodat ze aannemen dat er een verkeerde mimetype is voor de geüploade bestanden. Deze optie verzekerd je dat zulke bestanden die dit veroorzaken worden geweigerd.',
	...
	'DOWNLOAD_ADD_IPS_EXPLAIN'		=> 'Je kan meerdere IP-adressen of hostnamen in één keer verbannen door elk adres op een aparte regel in te voeren. Om een reeks van IP-adressen toe te voegen, onderscheid je ze met het begin en het einde met een liggend streepje (-), een asterix “*” kan je gebruiken als jokerteken.',
	'DOWNLOAD_REMOVE_IPS_EXPLAIN'	=> 'Je kan meerdere IP-adressen verwijderen (of uitsluiten) doormiddel van één keer de juiste combinatie van de muis en het toetsenbord te gebruiken van jouw computer en browser. Uitgesloten IP-adressen hebben een blauwe achtergrond.',
	...
	'IMAGE_LINK_SIZE_EXPLAIN'	=> 'Afbeeldingsbijlagen weergeven als tekst in een bericht als de afbeelding groter is dan dit. Om dit uit te schakelen, stel je de waardes in op 0px bij 0px.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Maximale grootte van een afbeeldingbijlagen. Om de afmetingscontrole te kunnen uitschakelen, dien je beide waardes in te stellen op 0px bij 0px.',
	...
	'NO_UPLOAD_DIR'				=> 'De upload-directory die je hebt opgegeven bestaat niet.',
	'NO_WRITE_UPLOAD'			=> 'De upload-directory die jij hebt opgegeven kan niet worden beschreven. Pas de permissies aan, zodat de webserver naar die directory kan schrijven.',
	...
	'SECURE_DOWNLOADS_EXPLAIN'		=> 'Als deze optie is ingeschakeld, zit er op downloads een limiet, die gebonden zijn aan IP-adressen/hostnamen die jij opgeeft.',
	...
	'SECURE_EMPTY_REFERRER_EXPLAIN'	=> 'Beveiligde downloads zijn gebaseerd op een verwijzing. Wil je de downloads voor diegene die de verwijzing weglaat toestaan?',
	...
	'UPLOAD_DIR_EXPLAIN'			=> 'Upload-directory voor bijlagen. Vergeet niet als je deze directory veranderd wanneer er zich al bestaande geüploade bijlagen bevinden, moet je ze handmatig kopiëren naar de nieuwe locatie.',
	'UPLOAD_ICON'					=> 'Upload-pictogram',
	'UPLOAD_NOT_DIR'				=> 'De upload-locatie die je hebt opgegeven blijkt geen directory te zijn.',
));

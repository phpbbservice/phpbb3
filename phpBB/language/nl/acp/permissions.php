...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Voor meer informatie over het instellen en het beheren van de permissies van je phpBB3-forum, bekijk <a href="http://docs.phpbbservice.nl/handleiding/3.0/snellestart/snel_permissies.php">hoofdstuk 1.5 van onze snelle start handleiding</a>.</p>
	',

	'ACL_NEVER'				=> 'Nooit',
	'ACL_SET'				=> 'Instellen van permissies',
	'ACL_SET_EXPLAIN'		=> 'Permissies zijn gebaseerd op een simpel <samp>JA</samp>/<samp>NEE</samp>-systeem. Instellen van een optie naar <samp>NOOIT</samp> voor een gebruiker of gebruikersgroep zal alle andere waarde overschrijven die er aan toegewezen is. Als je geen waarde wilt toewijzen aan een optie voor deze gebruiker of groep, selecteer dan <samp>NEE</samp>. Als waardes zijn toegewezen voor deze optie ergens anders, dan zullen ze worden gebruikt in voorkeur, anders is <samp>NOOIT</samp> verondersteld. Alle objecten die gemarkeerd ( met het selectievakje ) zijn, zullen de permissie kopiëren die je hebt opgegeven.',
	...
	'ACL_VIEW_EXPLAIN'		=> 'Hier kan je de effectieve permissies bekijken die de gebruiker/groep heeft. Een rode vierkant betekend dat de gebruiker/groep geen permissies heeft, een groene vierkant betekend dat de gebruiker/groep wel permissies heeft.',
	'ACL_YES'				=> 'Ja',

	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Hier kan je beheerderspermissies toewijzen aan gebruikers of groepen. Alle gebruikers met beheerderspermissies kunnen het beheerderspaneel zien.',
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'Hier kan je gebruikers en groepen als forummoderators toewijzen. Gebuik de juiste pagina om gebruikers toegang te geven tot forums, of om ze globale moderatorpermissies of beheerderspermissies te geven.',
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'Hier kan je instellen welke gebruikers en groepen toegang hebben tot welk forum. Gebuik de juiste pagina om moderators toe te wijzen of om beheerders te bepalen.',
	'ACP_FORUM_PERMISSIONS_COPY_EXPLAIN'		=> 'Hier kan je forumpermissies kopiëren van het ene forum naar andere of naar meerdere forums.',
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Hier kan je globale moderatorpermissies toewijzen aan gebruikers of groepen. Deze moderators zijn gelijk aan normale moderators behalve dat ze toegang hebben tot elk forum.',
	'ACP_GROUPS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier kan je forumpermissies toewijzen aan groepen.',
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Hier kan je globale permissies toewijzen aan groepen - gebruikerspermissies, globale moderatorpermissies en beheerderpermissies. Gebruikerspermissies bevatten de mogelijkheden zoals het gebruik van avatars, het versturen van privéberichten etc, globale moderatorpermissies o.a goedkeuren van berichten, beheren van onderwerpen, beheren van verbanningen etc, en als laatste beheerderspermissies zoals wijzigen van permissies, het opgeven van aangepaste BBCodes, beheren van forums, etc. Individuele gebruikerspermissies zullen alleen gewijzigd moeten worden in rare situaties, de voorkeursmethode is eigenlijk om gebruikers in groepen te plaatsen en dat je daarna groepspermissies toewijst.',
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Hier kan je de rollen voor de beheerderspermissies beheren. Rollen zijn effectieve permissies, als je een rol wijzigt zullen de permissies van de items die toegewezen zijn aan deze rol ook gewijzigt worden.',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'Hier kan je de rollen voor de forumpermissies beheren. Rollen zijn effectieve permissies, als je een rol wijzigt zullen de permissies van de items die toegewezen zijn aan deze rol ook gewijzigt worden.',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Hier kan je de rollen voor de moderatorpermissies beheren. Rollen zijn effectieve permissies, als je een rol wijzigt zullen de permissies van de items die toegewezen zijn aan deze rol ook gewijzigt worden.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Hier kan je de rollen voor de gebruikerspermissies beheren. Rollen zijn effectieve permissies, als je een rol wijzigt zullen de permissies van de items die toegewezen zijn aan deze rol ook gewijzigt worden.',
	'ACP_USERS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier kan je forumpermissies toewijzen aan gebruikers.',
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Hier kan je globale permissies toewijzen aan gebruikers - gebruikerspermissies, globale moderatorpermissies en beheerderpermissies. Gebruikerspermissies bevatten de mogelijkheden zoals het gebruik van avatars, het versturen van privéberichten etc, globale moderatorpermissies o.a goedkeuren van berichten, beheren van onderwerpen, beheren van verbanningen etc, en als laatste beheerderspermissies zoals wijzigen van permissies, het opgeven van aangepaste BBCodes, beheren van forums, etc. Om deze instellingen aan te passen voor een groot aantal gebruikers, raden we je aan om de groepspermissies te gebruiken. Gebruikerspermissies zullen alleen gewijzigd moeten worden in rare situaties, de voorkeursmethode is eigenlijk om gebruikers in groepen te plaatsen en dat je daarna groepspermissies toewijst.',
	...
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS_EXPLAIN'	=> 'Hier kan je de effectieve globale moderatorpermissies bekijken die toegewezen zijn aan de geselecteerde gebruikers/groepen.',
	'ACP_VIEW_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier kan je de effectieve forumpermissies bekijken die toegewezen zijn aan de geselecteerde gebruikers/groepen en forums.',
	'ACP_VIEW_FORUM_MOD_PERMISSIONS_EXPLAIN'	=> 'Hier kan je de effectieve moderatorpermissies bekijken die toegewezen zijn aan de geselecteerde gebruikers/groepen en forums.',
	...
	'COPY_PERMISSIONS_CONFIRM'				=> 'Weet je zeker dat je deze actie wilt uitvoeren? Vergeet niet dat dit alle bestaande permissies zal overschrijven op de geselecteerde doelen.',
	'COPY_PERMISSIONS_FORUM_FROM_EXPLAIN'	=> 'Het bronforum waar je de permissies van wilt kopiëren.',
	'COPY_PERMISSIONS_FORUM_TO_EXPLAIN'		=> 'De bestemmingsforums waar je de gekopieerde permissies op wilt toepassen.',
	...
	'DELETE_ROLE_CONFIRM'		=> 'Weet je zeker dat je deze rol wilt verwijderen? Items die deze rol hebben toegewezen zullen hun permissies <strong>niet</strong> verliezen.',
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'Wanneer je het instelt naar deze rol, zal het de permissies niet wijzigen aan de rechterkant. Als je alle permissies niet ingesteld wilt hebben of wilt verwijderen, dan moet je de “Alles <samp>NEE</samp>”-link gebruiken.',
	...
	'ONLY_FORUM_DEFINED'	=> 'Je hebt alleen forums opgegeven in jouw selectie. Selecteer tenminste ook één gebruiker of één groep.',
	...
	'ROLE_DESCRIPTION_ADMIN_USERGROUP'		=> 'Kan groepen en gebruikers beheren. En is in staat om permissies, instellingen te wijzigen en om verbanningen enrangs te beheren.',
	...
	'ROLE_DESCRIPTION_FORUM_STANDARD'		=> 'Kan de meeste forumfunctionaliteiten gebruiken inclusief bijlagen en het verwijderen van eigen onderwerpen, maak kan niet eigen onderwerpen sluiten, en kan niet peilingen aanmaken.',
	...
	'ROLE_DESCRIPTION_EXPLAIN'		=> 'Je kan een korte beschrijving opgeven van wat de rol doet of waarvoor het bedoelt is. De tekst die je hier opgeeft zal ook worden weergegeven in het permissiescherm.',
	...
	'SELECT_FORUM_SUBFORUM_EXPLAIN'	=> 'Het forum dat je hier selecteert zal inclusief alle subforums zijn binnen de selectie.',

...
*
* @package language
* @version $Id: prune.php 197 2009-10-08 19:50:08Z Raimon $
...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> 'Deze sectie stelt je in staat om gebruikers van jouw forum te deactiveren of verwijderen. Accounts kan je filteren op verschillende manieren; op berichtenaantal, meest recente activiteit, etc. Criteria kunnen worden gecombineerd om te beperken welke accounts zullen worden meegenomen. Bijvoorbeeld kan je gebruikers opschonen, die minder als 10 berichten hebben en die ook inactief zijn na 2002-01-01. Als alternatief kan je de selectie criteria volledig overslaan door een lijst van gebruikers in te voeren (elke op een aparte regel) in het tekstveld. Wees voorzichtig met deze faciliteit! Wanneer een gebruiker is verwijderd, is er geen weg terug om deze actie terug te draaien.',

	'DEACTIVATE_DELETE'			=> 'Deactiveren of verwijderen',
	'DEACTIVATE_DELETE_EXPLAIN'	=> 'Kies of je de gebruikers wilt deactiveren of meteen wilt verwijderen. Vergeet niet dat verwijderde gebruikers niet meer hersteld kunnen worden!',
	...
	'JOINED_EXPLAIN'			=> 'Voer een datum in het <kbd>YYYY-MM-DD</kbd> formaat.',

	'LAST_ACTIVE_EXPLAIN'		=> 'Voer een datum in het <kbd>YYYY-MM-DD</kbd> formaat. Voer <kbd>0000-00-00</kbd> in om gebruikers die zich nog nooit hebben aangemeld te laten opschonen, <em>ervoor</em> en <em>erna</em> condities zullen worden genegeerd.',
	...
	'WRONG_ACTIVE_JOINED_DATE'	=> 'De datum die is ingevoerd is verkeerd, het wordt verwacht in het <kbd>YYYY-MM-DD</kbd> formaat.',
));

// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'Dit zal alle onderwerpen verwijderen waar nog niks in is geplaatst of die nog niet bekeken zijn binnen het aantal dagen dat je hebt geselecteerd. Als je geen nummer invoert dan zullen alle onderwerpen worden verwijderd. Standaard, zal het geen onderwerpen verwijderen met peilingen die nog steeds lopen ook zal het geen stickies en mededelingen verwijderen.',
	...
	'PRUNE_FORUM_CONFIRM'			=> 'Weet je zeker dat je de geselecteerde forums wilt opschonen met de instellingen die zijn opgegeven? Wanneer het is verwijderd, is er geen mogelijkheid om de opgeschoonde berichten en onderwerpen te herstellen.',

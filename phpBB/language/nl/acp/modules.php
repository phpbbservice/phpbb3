...
*
* @package language
* @version $Id: modules.php 197 2009-10-08 19:50:08Z Raimon $
...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Hier kan je alle modules beheren. Vergeet niet dat het beheerderspaneel een drie-niveau menustructuur heeft (Categorie -> Categorie -> Module) waardoor de andere beschrikken over een twee niveaus menustructuur (Categorie -> Module) wat behouden moet blijven. Vergeet ook niet dat het mogelijk is dat je jezelf kan uitsluiten als je de modules die verantwoordelijk zijn voor het beheren van de modules verwijderd of uitschakeld.',
	'ADD_MODULE'					=> 'Module toevoegen',
	'ADD_MODULE_CONFIRM'			=> 'Weet je zeker dat je de geselecteerde module wilt toevoegen met de geselecteerde mode?',
	'ADD_MODULE_TITLE'				=> 'Module toevoegen',

	'CANNOT_REMOVE_MODULE'	=> 'Niet in staat om de module te verwijderen, het heeft onderligende modules. Verwijder alle alle onderliggende modules voordat je verder gaat met deze actie.',
	'CATEGORY'				=> 'Categorie',
	...
	'EDIT_MODULE_EXPLAIN'	=> 'Hier kan je gespecificeerde module-instellingen invoeren.',
	...
	'MODULE_DISPLAYED_EXPLAIN'	=> 'Als je niet dat deze module wordt weergegeven, maar je wilt het wel gebruiken, stel dit dan in op nee.',
	...
	'NO_CATEGORY_TO_MODULE'	=> 'Niet in staat om de categorie terug te zetten in een module. Verwijder/verplaats alle modules die onder deze categorie zitten, voordat je verder gaat met deze actie.',

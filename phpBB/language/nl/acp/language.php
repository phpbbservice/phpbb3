...
*
* @package language
* @version $Id: language.php 197 2009-10-08 19:50:08Z Raimon $
...
$lang = array_merge($lang, array(
	...
	'ACP_LANGUAGE_PACKS_EXPLAIN'	=> 'Hier kan je taalpakketten installeren/verwijderen. Het standaard taalpakket is gemakeerd met een jokerteken (*).',
	...
	'LANGUAGE_ENTRIES_EXPLAIN'			=> 'Hier kan je bestaande taalregels wijzigen of de nog niet vertaalde regels alsnog vertalen.<br /><strong>Opmerking:</strong> Wanneer je een taalbestand wijzigt, de wijzigingen zullen worden opgeslagen in een aparte map, zodat je ze later kan downloaden. De wijzigingen zullen voor niemand zichtbaar zijn totdat je het nieuwe bestand op de plaats van het bestaande taalbestand op je webruimte hebt neerzet.',
	...
	'NO_FILE_SELECTED'				=> 'Je hebt geen taalbestand opgegeven.',
	'NO_LANG_ID'					=> 'Je hebt geen taalpakket opgegeven.',
	'NO_REMOVE_DEFAULT_LANG'		=> 'Je kan niet het standaard taalpakket verwijderen.<br />Als je dit taalpakket wilt verwijderen, moet je eerst de standaard forumtaal wijzigen.',
	...
	'UPLOAD_FAILED'				=> 'De upload is mislukt om onbekende redenen. Je zal het bestand handmatig moeten vervangen.',

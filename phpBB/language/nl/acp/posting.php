...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'BBCode is een speciale implantatie van HTML, het bied betere controle over hoe iets wordt weergegeven. Vanuit deze pagina kan je aangepaste BBCodes toevoegen, wijzigen en verwijderen.',
	'ADD_BBCODE'				=> 'Nieuwe BBCode toevoegen',
	
	'BBCODE_DANGER'				=> 'De BBCode die je probeert toe te voegen blijkt een {TEXT}-element te gebruiken binnen een HTML-attribuut. Dit kan een mogelijke XSS-veiligheidsprobleem veroorzaken. Probeer in plaats van de {TEXT}-type een meer beperkte type te gebruiken zoals de {SIMPLETEXT} of {INTTEXT}. Ga alleen verder als je de risico’s begrijpt die de {TEXT}-token met zich meebrengt, en/of dat het gebruik van de {TEXT}-token onvermijdelijk is.',
	...
	'BBCODE_HELPLINE'			=> 'Tip',
	'BBCODE_HELPLINE_EXPLAIN'	=> 'Dit veld bevat de tekst die weergegeven wordt zodra je met je muis over de BBCode gaat.',
	'BBCODE_HELPLINE_TEXT'		=> 'Tiptekst',
	'BBCODE_HELPLINE_TOO_LONG'	=> 'De tip die je hebt ingevoerd is te lang.',

	'BBCODE_INVALID_TAG_NAME'	=> 'De tagnaam van de BBCode die je geselecteerd hebt bestaat al.',
	...
	'BBCODE_TAG'				=> 'Tag',
	'BBCODE_TAG_TOO_LONG'		=> 'De tagnaam die je hebt geselecteerd is te lang.',
	'BBCODE_TAG_DEF_TOO_LONG'	=> 'De opgegeven tagnaam die je hebt ingevoerd is te lang, kort je tagnaam in.',
	'BBCODE_USAGE'				=> 'BBCode gebruik',
	'BBCODE_USAGE_EXAMPLE'		=> '[highlight={COLOR}]{TEXT}[/highlight]<br /><br />[font={SIMPLETEXT1}]{SIMPLETEXT2}[/font]',
	'BBCODE_USAGE_EXPLAIN'		=> 'Hier kan je opgeven hoe de BBCode gebruikt kan worden. Vervang alle variabele invoer door het juiste element (%szie hieronder%s).',
	...
	'HTML_REPLACEMENT_EXPLAIN'		=> 'Hier kan je de standaard HTML-vervanging opgeven. Vergeet niet om de elementen die je hierboven hebt gebruikt terug te zetten!',

	'TOKEN'					=> 'Element',
	'TOKENS'				=> 'Elementen',
	'TOKENS_EXPLAIN'		=> 'Elementen zijn plaatsvervangers voor de gebruikersinvoer. Hetgene wat ingevoerd is zal alleen worden gecontroleerd als het overeenkomt met de bijbehorende omschrijving. Als het nodig is kan je ook cijfers toevoegen aan het laatste teken tussen de koppels, bijvoorbeeld: {TEXT1}, {TEXT2}.<br /><br />Binnen de HTML-vervanging kan je ook taalwaarden gebruiken die voorkomen in jouw language/-directory zoals dit:  {L_<em>&lt;STRINGNAME&gt;</em>}  wat <em>&lt;STRINGNAME&gt;</em> de vertaalwaarde is die je wilt toevoegen. Als voorbeeld; {L_WROTE} zal worden weergegeven als “schreef” of hoe het vertaald is in de forumtaal die de gebruikers hebben geselecteerd.<br /><br /><strong>Vergeet niet dat je alleen de elementen kan gebruiken die hieronder zijn weergegeven met aangepaste BBCodes.</strong>',
	'TOKEN_DEFINITION'		=> 'Wat kan het zijn?',
	'TOO_MANY_BBCODES'		=> 'Je kan geen BBCodes meer aanmaken. Verwijder één of meerde BBCodes en probeer het daarna opnieuw.',

	'tokens'	=>	array(
		'TEXT'			=> 'Een tekst, inclusief vreemde tekens, cijfers, etc… Je zal dit element niet moeten gebruiken binnen HTML-tags. Gebruik in plaats daarvan de IDENTIFIER, INTTEXT of SIMPLETEXT.',
...
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'Vanuit deze pagina kan je pictogrammen toevoegen, verwijderen en wijzigen die de gebruikers mogen toevoegen aan onderwerpen, berichten of privéberichten. Deze pictogrammen zijn normaal weergegeven naast de onderwerptitel in de forumlijst of in de berichttitel in de onderwerplijst. Je kan ook nieuwe pakketten van pictogrammen installeren en aanmaken.',
	'ACP_SMILIES_EXPLAIN'	=> 'Smileys of emoticons zijn typische kleine, soms geanimeerde afbeeldingen die gebruikt worden om een emotie of een gevoel uit te drukken. Vanuit deze pagina kan je emoticons toevoegen, verwijderen en wijzigen die gebruikers kunnen gebruiken in hun berichten en privéberichten. Je kan ook nieuwe pakketten van smileys installeren en aanmaken.',
	...
	'CURRENT_ICONS_EXPLAIN'		=> 'Kies wat je wilt doen met de huidige geïnstalleerde pictogrammen.',
	'CURRENT_SMILIES'			=> 'Huidige smileys',
	'CURRENT_SMILIES_EXPLAIN'	=> 'Kies wat je wilt doen met de huidige smileys.',
	...
	'EXPORT_ICONS_EXPLAIN'		=> '%sWanneer je op deze link klikt, zal de configuratie van jouw geïnstalleerde pictogrammen worden ingepakt in <samp>icons.pak</samp>. Wanneer je het download kan het worden gebruikt om een <samp>.zip</samp> of <samp>.tgz</samp> bestand aan te maken, het zal al jouw pictogrammen bevatten plus het <samp>icons.pak</samp> configuratiebestand%s.%s',
	'EXPORT_SMILIES'			=> 'Smilies.pak exporteren en downloaden',
	'EXPORT_SMILIES_EXPLAIN'	=> '%sWanneer je op deze link klikt, zal de configuratie van jouw geïnstalleerde smileys worden ingepakt in <samp>smilies.pak</samp>. Wanneer je het download kan het worden gebruikt om een <samp>.zip</samp> of <samp>.tgz</samp> bestand aan te maken, het zal al jouw smileys bevatten plus het <samp>smilies.pak</samp> configuratiebestand.%s',
	...
	'NO_ICONS_EXPORT'	=> 'Je hebt geen pictogrammen om een pakket mee aan te maken.',
	...
	'NO_SMILIES_EXPORT'	=> 'Je hebt geen smileys om een pakket mee aan te maken.',
	...
	'SMILIE_NO_FILE'			=> 'De smiley “%s” is genegeerd, omdat het bestand ontbreekt.',
...
// Ranks
$lang = array_merge($lang, array(
	'ACP_RANKS_EXPLAIN'		=> 'Door dit formulier te gebruiken kan je rangen toevoegen, wijzigen, bekijken en verwijderen. Je kan ook speciale rangen aamaken die toegewezen kunnen worden aan een gebruiker via de optie in het gebruikersbeheer.',
	...
	'NO_UPDATE_RANKS'		=> 'De rang is succesvol verwijderd. Maar gebruikersaccounts die deze rang gebruiken zijn niet bijgewerkt. Je moet de rang voor die accounts handmatig resetten.',
...
// Disallow Usernames 
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Hier kan je controleren welke gebruikersnamen niet gebruikt mogen worden. Niet-toegestaande gebruikersnamen mogen een jokerteken (*) bevatten.',
	'ADD_DISALLOW_EXPLAIN'	=> 'Je kan een gebruikersnaam niet-toestaan doormiddel van een joker (*) te gebruiken zodat het overeenkomt met elk teken.',
	'ADD_DISALLOW_TITLE'	=> 'Een niet-toegestaande gebruikersnaam toevoegen',

	'DELETE_DISALLOW_EXPLAIN'	=> 'Je kan een niet-toegestaande gebruikersnaam verwijderen door de gebruikersnaam te selecteren van deze lijst en daarna op de versturen-knop te klikken.',
	'DELETE_DISALLOW_TITLE'		=> 'Een niet-toegestaande gebruikersnaam verwijderen',
	'DISALLOWED_ALREADY'		=> 'De naam die je hebt ingevoerd is al niet-toegestaan.',
	'DISALLOWED_DELETED'		=> 'De niet-toegestaande gebruikersnaam is succesvol verwijderd.',
	'DISALLOW_SUCCESSFUL'		=> 'De niet-toegestaande gebruikersnaam is succesvol toegevoegd.',

	'NO_DISALLOWED'				=> 'Er zijn geen niet-toegestaande gebruikersnamen.',
	'NO_USERNAME_SPECIFIED'		=> 'Je hebt geen gebruikersnaam geselecteer of opgegeven.',
));

// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'Hier kan je redenen beheren die gebruikt worden in meldingen en bij afkeuringsberichten wanneer er berichten worden afgekeurd. Er is één standaard reden (gemarkeerd met een jokerteken *) die je niet kan verwijderen, deze reden is normaal gebruikt voor aangepaste berichten als er er geen reden bij past.',
	...
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'De reden is <strong>niet</strong> vertaald. Als je de vertaalde tekst wilt opgeven, geef dan de correcte variabele van de meldingsredenen sectie die in de taalbestanden staan.',
	'IS_TRANSLATED'				=> 'Reden is vertaald.',
	'IS_TRANSLATED_EXPLAIN'		=> 'De reden is vertaald. Als de titel die je hier hebt ingevoerd, opgegeven is in de meldingsredenen sectie van de taalbestanden, dan zal de vertaalde tekst van de titel en beschrijving gebruikt worden.',

	'NO_REASON'					=> 'Reden kon niet worden gevonden.',
	'NO_REASON_INFO'			=> 'Je moet een titel en beschrijving opgeven voor deze reden.',
	'NO_REMOVE_DEFAULT_REASON'	=> 'Je kan niet de standaard reden “Anders” verwijderen.',
	...
	'REASON_EDIT_EXPLAIN'		=> 'Hier kan je een reden toevoegen of wijzigen. Als de reden is vertaald dan zal de vertaalde versie gebruikt worden inplaats van de beschrijving die hier is ingevoerd.',

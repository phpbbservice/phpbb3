...
*
* @package language
* @version $Id: database.php 197 2009-10-08 19:50:08Z Raimon $
...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'Hier kan een back-up maken van al je phpBB gerelateerde gegevens. Je mag het geresulteerde archief in je <samp>store/</samp>-map opslaan of het direct downloaden. Afhankelijk van jouw server-configuratie kan je het bestand comprimeren in verschilende formaten.',
	'ACP_RESTORE_EXPLAIN'	=> 'Dit zal een volledig herstel uitvoeren op al je phpBB-tabellen van een opgeslagen bestand. Als je server het ondersteund kan je gzip of bzip ingepakte tekstbestanden gebruiken en het zal automatisch uitgepakt worden. <strong>WAARSCHUWING</strong> dit zal alle bestaande gegevens overschrijven. Het herstel kan enige tijd in beslag nemen, verlaat ook niet deze pagina totdat het compleet is. Back-ups zijn opgeslagen in de <samp>store/</samp>-map en zouden gegeneerd zijn door de back-up functionaliteit van phpBB. Herstellen van back-ups die niet zijn gemaakt door het ingebouwde systeem zullen waarschijnlijk niet werken.',
	...
	'TABLE_SELECT_ERROR'=> 'Je moet minstens één tabel selecteren.',
));

...
*
* @package language
* @version $Id: profile.php 197 2009-10-08 19:50:08Z Raimon $
...
$lang = array_merge($lang, array(
	...
	'BOOL_ENTRIES_EXPLAIN'	=> 'Voer nu je opties in',
	...
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'Het profielveld zal worden weergegeven in alle locaties die zijn toegestaan in de laadinstellingen. Als je dit insteld op “nee” zal het veld niet worden weergegeven op de onderwerppagina’s, profielen en de ledenlijst.',
	'DROPDOWN_ENTRIES_EXPLAIN'		=> 'Je kan je opties hier nu invoeren, elke optie moet op één nieuwe regel beginnen.',

	'EDIT_DROPDOWN_LANG_EXPLAIN'	=> 'Vergeet niet dat je jouw tekstopties kunt wijzigen en dat je ook nieuwe opties kunt toevoegen op het einde. Het is niet geadviseerd op nieuwe opties toe te voegen tussen bestaande opties - dit kan resulteren in het toewijzen van verkeerde opties aan jouw gebruikers. Dit kan ook gebeuren als je tussen opties verwijderd. Het verwijderen van opties van het einde, zal resulteren dat de toegewezen items van gebruikers zullen worden teruggedraaid naar de standaardwaarde.',
	'EMPTY_FIELD_IDENT'				=> 'Je moet een veld-ID invoeren.',
	'EMPTY_USER_FIELD_NAME'			=> 'Je moet een veldnaam/titel invoeren.',
	'ENTRIES'						=> 'Waarden',
	...
	'FIELD_TYPE'				=> 'Veldtype',
	'FIELD_TYPE_EXPLAIN'		=> 'Je kan het veldtype later niet wijzigen.',
	...
	'STEP_1_EXPLAIN_CREATE'			=> 'Hier kan je de eerste basisparameters invoeren van jouw nieuwe profielveld. Deze informatie is nodig voor de tweede stap, waar je de overgebleven opties kan instellen en jouw profielveld verder kan aanpassen.',
	'STEP_1_EXPLAIN_EDIT'			=> 'Hier kan je de basisparameters van jouw profielveld wijzigen. De relevante opties worden herberekend bij de volgende stap.',
	'STEP_1_TITLE_CREATE'			=> 'Profielveld toevoegen',
	'STEP_1_TITLE_EDIT'				=> 'Profielveld wijzigen',
	'STEP_2_EXPLAIN_CREATE'			=> 'Hier kan je sommige standaardopties bepalen die je kan aanpassen.',
	'STEP_2_EXPLAIN_EDIT'			=> 'Hier kan je sommige standaardopties wijzigen.<br /><strong>Vergeet niet dat dat wijzigingen aan profielvelden geen effect zullen hebben op bestaande profielvelden die al ingevoerd zijn door jouw gebruikers.</strong>',
	'STEP_2_TITLE_CREATE'			=> 'Specifieke profieltype opties',
	'STEP_2_TITLE_EDIT'				=> 'Specifieke profieltype opties',
	'STEP_3_EXPLAIN_CREATE'			=> 'Omdat je meer als één forumtaal hebt geïnstalleerd, moet je nu ook de overgebleven taalitems opgeven. Het profielveld zal werken met de ingeschakelde standaardtaal, je kan ook later de overgebleven taalitems opgeven.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Omdat je meer als één forumtaal hebt geïnstalleerd, kan je nu ook de overgebleven taalitems toevoegen of wijzigen. Het profielveld zal werken met de ingeschakelde standaardtaal.',
	'STEP_3_TITLE_CREATE'			=> 'Overgebleven taalopties',
	'STEP_3_TITLE_EDIT'				=> 'Taalopties',
	'STRING_DEFAULT_VALUE_EXPLAIN'	=> 'Voer een standaardzin die moet worden weergegeven als een standaardwaarde. Laat het leeg wanneer je wilt om het eerst leeg te laten weergeven.',

	'TEXT_DEFAULT_VALUE_EXPLAIN'	=> 'Voer een standaardtekst in die zal worden weergegeven als een standaardwaarde. Laat het leeg wanneer je wilt om het eerst leeg te laten weergeven.',
	'TRANSLATE'						=> 'Vertaal',

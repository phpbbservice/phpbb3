...
*
* @package language
* @version $Id: search.php 330 2010-11-14 22:15:21Z Raimon $
...
$lang = array_merge($lang, array(
	'ACP_SEARCH_INDEX_EXPLAIN'				=> 'Hier kan je de indexen van alle zoekmethodes beheren. Aangezien je normaal maar één zoekmethode gebruikt, zal je alle indexen die je niet gebruikt moeten verwijderen. Als je sommige zoekinstellingen wijzigt (bijvoorbeeld; het aantal minimale/maximale tekens) is het raadzaam om de index opnieuw aan te maken zodat het de wijzigingen bevat.',
	'ACP_SEARCH_SETTINGS_EXPLAIN'			=> 'Hier kan je opgeven welke zoekmethode er gebruikt zal worden voor het indexeren van berichten en het uitvoeren van zoekopdrachten. Je kan diverse opties instellen die invloed kunnen hebben op het verwerken van deze acties. Sommige instellingen zijn hetzelfde voor de engines van alle zoekmethodes.',
	...
	'CONFIRM_SEARCH_BACKEND'				=> 'Weet je zeker dat je wilt ruilen naar een andere zoekmethode? Nadat het wijzigen van de zoekmethode voltooid is, zal je een index moeten aanmaken voor de nieuwe zoekmethode. Als je niet meer van plan bent om te wijzigen naar de oude zoekmethode kan je ook de index van de oude zoekmethodes verwijderen om schijfruimte vrij te maken.',
	'CONTINUE_DELETING_INDEX'				=> 'Doorgaan met het vorige verwijderingsproces van de index',
	'CONTINUE_DELETING_INDEX_EXPLAIN'		=> 'Een vorig verwijderingsproces is al eerder gestart. Om de zoekindex-pagina te kunnen betreden zal je het verwijderingsproces moeten voltooien of annuleren.',
	'CONTINUE_INDEXING'						=> 'Doorgaan met het vorige indexeringsproces',
	'CONTINUE_INDEXING_EXPLAIN'				=> 'Een vorig indexeringsproces is al eerder gestart. Om de zoekindex-pagina te kunnen betreden zal je het indexeringsproces moeten voltooien of annuleren.',
	...
	'FULLTEXT_MYSQL_PCRE_EXPLAIN'			 => 'Deze zoekmethode vereist de PCRE unicode tekens eigenschappen voor als je wilt zoeken voor niet-Latijnse tekens, dit is echter alleen beschikbaar in PHP 4.4, 5.1 en hoger.',
	...
	'INDEXING_IN_PROGRESS_EXPLAIN'			=> 'De zoekmethode is momenteel alle berichten van het forum aan het indexeren. Dit kan enige minuten tot een paar uur in beslag nemen, afhankelijk van de grootte van je forum.',
	...
	'SEARCH_STORE_RESULTS_EXPLAIN'			=> 'Gecachte zoekresultaten die na deze tijd, in seconden zullen verlopen. Stel het in op 0 als je de zoek-cache wilt uitschakelen.',
	'SEARCH_TYPE'							=> 'Zoekmethode',
	'SEARCH_TYPE_EXPLAIN'					=> 'phpBB staat je toe om een zoekmethode te kiezen die gebruikt wordt om tekst te zoeken in berichten. Standaard zal het de eigen phpBB fulltext zoekmethode gebruiken.',
	'SWITCHED_SEARCH_BACKEND'				=> 'Je hebt een andere zoekmethode geselecteerd. Om de nieuwe zoekmethode correct te gebruiken moet je er zeker van zijn dat er een index is voor de methode die jij hebt gekozen.',

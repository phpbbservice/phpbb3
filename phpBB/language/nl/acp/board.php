...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Hier kan je de plug-ins selecteren en configureren, welke zijn ontworpen om formulieren die automatisch worden verstuurt door spambots te blokeren. Deze plug-ins werken door de gebruiker uit te dagen om een <em>CAPTCHA</em> op te lossen, dat is een test die erg moeilijk op te lossen is voor computers.',
...
$lang = array_merge($lang, array(
	...
	'USE_SMTP_EXPLAIN'				=> 'Selecteer “Ja” als je wilt dat e-mails worden verstuurt via een naamserver, inplaats van de lokale mail-functie.',
));

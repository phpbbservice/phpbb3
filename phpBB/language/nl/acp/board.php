...
$lang = array_merge($lang, array(
	'ACP_BOARD_SETTINGS_EXPLAIN'	=> 'Hier kan je de basisinstellingen van je forum bepalen, geef het een gepaste naam en beschrijving, pas samen met de andere instellingen bijvoorbeeld de standaard waarden aan voor de tijdszone en de taal.',
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Dit zal het forum onbereikbaar maken voor gebruikers die geen beheerders of moderators zijn. Je kan ook een korte tekst van 255 tekens laten weergeven als je wilt.',
...
// Board Features
$lang = array_merge($lang, array(
	'ACP_BOARD_FEATURES_EXPLAIN'	=> 'Hier kan je diverse forumfuncties in-/uitschakelen.',
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Met deze instelling kan je de snelle reactie volledig uitschakelen op het forum. Wanneer het is ingeschakeld, zullen de forum gespecificeerde instellingen worden gebruikt om te bepalen of de snelle reactie moet worden weergegeven in een forum.',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Het pad onder je phpBB-hoofddirectory voor vooringestelde afbeeldingen, bijvoorbeeld; <samp>images/avatars/gallery</samp>.',
	'AVATAR_STORAGE_PATH'			=> 'Avatar-opslagpad',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Het pad onder uw phpBB-hoofddirectory bijvoorbeeld; <samp>images/avatars/upload</samp>. <br />Het uploaden van avatars <strong>zal niet beschikbaar zijn</strong> als deze map niet schrijfbaar is.',
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Voor geüploade avatar-bestanden. Als deze waarde 0 is, zal de maximale geüploade bestandsgrootte worden gebruikt die is opgegeven in je PHP-configuratie.',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Aantal minuten, uren of dagen tussen het laatste bericht in een onderwerp en de mogelijkheid om het onderwerp opnieuw onder de aandacht te brengen. Door de waarde op 0 in te stellen schakel je het omhooghalen van berichten volledig uit.',
	...
	'DELETE_TIME_EXPLAIN'			=> 'Beperkt de tijd die beschikbaar is om een nieuw bericht te verwijderen. Door de waarde op 0 in te stellen schakel je deze functie uit.',
	...
	'EDIT_TIME_EXPLAIN'				=> 'Beperkt de tijd die beschikbaar is om een nieuw bericht te wijzigen. Stel deze waarde in op 0 om dit gedrag uit te schakelen.',
	'FLOOD_INTERVAL'				=> 'Tijd tussen berichten',
	'FLOOD_INTERVAL_EXPLAIN'		=> 'Aantal seconden dat een gebruiker moet wachten tussen het plaatsten van nieuwe berichten. Om gebruikers deze optie te laten negeren, pas je hun permissies aan.',
	'HOT_THRESHOLD'					=> 'Aantal berichten voor een populair onderwerp',
	'HOT_THRESHOLD_EXPLAIN'			=> 'Aantal berichten per onderwerp dat nodig is om de populair-status te bereiken. Stel deze in op 0 om populaire onderwerpen uit te schakelen.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'Dit bepaald of gebruikers meteen toegang hebben tot het forum of dat een bevestiging eerst is vereist. Je kan ook nieuwe registraties volledig uitschakelen. “Forum e-mails” moet ingeschakeld zijn om de gebruikers- of beheerdersactivatie te kunnen gebruiken.',
	'NEW_MEMBER_POST_LIMIT'			=> 'Berichtlimiet voor nieuwe leden',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Nieuwe leden worden geplaatst in de <em>Pas geregistreerde gebruikers</em>groep totdat ze dit aantal berichten hebben bereikt worden ze verwijderd uit deze groep. Je kan deze groep gebruiken om te voorkomen dat ze het privéberichten-systeem kunnen gebruiken of dat je eerst hun berichten wilt herzien voordat ze publiekelijk zichtbaar zijn voor iedereen. <strong>Een waarde van 0 schakelt deze functie uit.</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'		=> 'Pas geregistreerde gebruikersgroep als standaardgroep instellen',
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Wanneer je dit instelt op ja, en het berichtlimiet voor nieuwe leden is opgegeven, dan zullen de pas geregistreerde gebruikers niet alleen worden geplaatst in de <em>Pas geregistreerde gebruikers</em>groep, maar zal dit ook hun standaard groep worden. Dit kan handig zijn als je voor deze groep een standaard rang en/of avatar wilt toewijzen, de gebruikers in deze groep zullen dan automatisch de rang en/of avatar overnemen.',

	'ACC_ADMIN'					=> 'Door beheerder',
	'ACC_DISABLE'				=> 'Registratie uitschakelen',
	'ACC_NONE'					=> 'Geen activatie (meteen toegang)',
	'ACC_USER'					=> 'Door gebruiker (bevestiging via e-mail)',
//	'ACC_USER_ADMIN'			=> 'Gebruiker + Beheerder',
	...
	'ENABLE_COPPA_EXPLAIN'		=> 'Dit vereist gebruikers op te geven of ze 13 jaar of ouder zijn voor de U.S. COPPA-wet. Als je dit uitschakeld zullen de specifieke COPPA-groepen niet meer worden weergegeven.',
	'MAX_CHARS'					=> 'Maximaal',
	'MIN_CHARS'					=> 'Minimaal',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Dit zal de ATOM-feeds voor heel het forum in- of uitschakelen.<br />Wanneer je dit uitschakelt zal het alle feeds uitschakelen, het maakt niet uit hoe de opties hieronder zijn ingestelt.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Hier kan je de plug-ins selecteren en configureren, welke zijn ontworpen om formulieren die automatisch worden verstuurd door spambots te blokeren. Deze plug-ins werken door de gebruiker uit te dagen om een <em>CAPTCHA</em> op te lossen, dat is een test die erg moeilijk op te lossen is voor computers.',
	...
	'CAPTCHA_GD_FONTS_EXPLAIN'				=> 'Deze instelling controleert hoeveel verschilende letters en vormen er gebruikt worden. Je kunt gewoon de standaard vormen gebruiken of aangepaste letters introduceren. Toevoegen van kleine letters is ook mogelijk.',
	...
	'CAPTCHA_PREVIEW_MSG'					=> 'Je wijzigingen zijn nog niet opgeslagen, dit is enkel een voorbeeld.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'De plug-in zal op dit voorbeeld lijken wanneer je de huidige selectie gebruikt.',
	...
	'VISUAL_CONFIRM_REFRESH'				=> 'Toestaan dat gebruikers de anti-spambot taak kunnen vernieuwen',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'De details bepalen de data die wordt gebruikt om cookies te versturen naar de gebruikers-browsers. In de meeste gevallen zijn de standaard waarden voor de cookie-instellingen meer als voldoende. Als je ze moet wijzigen, doe dit dan met zorg, verkeerde instellingen kunnen er namelijk voor zorgen dat gebruikers zich niet meer kunnen aanmelden.',

	'COOKIE_DOMAIN'				=> 'Cookie-domein',
	'COOKIE_NAME'				=> 'Cookie-naam',
	'COOKIE_PATH'				=> 'Cookie-pad',
	'COOKIE_SECURE'				=> 'Cookie-beveiliging',
	'COOKIE_SECURE_EXPLAIN'		=> 'Als je server gebruikt maakt van SSL kan je deze optie inschakelen, anders kan je deze optie gewoon uitgeschakeld laten staat. Als je dit hebt ingeschakeld en je maakt geen gebruik van SSL, zal het resulteren in server-fouten tijdens doorverwijzingen.',
...
// Load Settings
$lang = array_merge($lang, array(
	'ACP_LOAD_SETTINGS_EXPLAIN'	=> 'Hier kan je enkele forumfuncties in/-uitschakelen, om de laadtijd te verkorten. Bij de meeste servers is het niet nodig deze opties uit te schakelen. Maar bij sommige systemen of op shared hosting servers is het echter beter om functies uit te schakelen die je niet nodig hebt. Je kan ook een bepaalde beperking opgeven voor de serverbelasting en het aantal actieve sessies voordat het forum offline gaat.',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBB ondersteunt authenticatie-plug-ins, of modules. Deze laten je bepalen hoe gebruikers zijn geauthenticeerd wanneer ze zich aanmelden op het forum. Standaard zijn er drie plug-ins meegeleverd; DB, LDAP en Apache. Niet alle methodes hebben de nodigde bijkomende informatie, dus vul alleen de velden in die relevant zijn voor de geselecteerde methode.',

	'AUTH_METHOD'				=> 'Een authenticatie-methode selecteren',

	'APACHE_SETUP_BEFORE_USE'	=> 'Je moet eerst de apache-authenticatie installeren voordat je phpBB wijzigt naar deze authenticatie-methode. Vergeet niet dat de gebruikersnaam die gebruikt wordt voor deze apache-authenticatie dezelfde moet zijn als je phpBB-gebruikersnaam. Apache-authenticatie kan alleen worden gebruikt met de mod_php (niet met een CGI-versie) en de safe_mode moet uitgeschakeld zijn.',
	...
	'LDAP_EMAIL_EXPLAIN'			=> 'Stel dit in naar de naam die hebt je opgegeven van je gebuiker e-mail-attribuut (als die bestaat) om automatisch het e-mailadres in te stellen voor nieuwe gebruikers. Als je dit leeg laat zal dit resulteren in een leeg e-mailadres voor gebruikers die de eerste keer zich aanmelden.',
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'Laat dit leeg als je gebruik maakt van gasttoegang, anders vult je het wachtwoord in voor de bovengenoemde gebruiker. Dit is nodig voor Aktieve Directory Servers.<br /><em><strong>Waarschuwing:</strong> Dit wachtwoord wordt opgeslagen als normale tekst in de database, en is zichtbaar voor iedereen die toegang heeft tot de database of wie deze configuratiepagina kan bekijken.</em>',
	'LDAP_PORT'						=> 'LDAP-serverpoort',
	'LDAP_PORT_EXPLAIN'				=> 'Optioneel kan je een poort opgeven die gebruikt moet worden om een verbinding te leggen naar de LDAP-server inplaats van de standaard poort 389.',
	'LDAP_SERVER'					=> 'LDAP-servernaam',
	'LDAP_SERVER_EXPLAIN'			=> 'Als je LDAP gebruikt, is dit de hostnaam of het IP-adres van de LDAP-server. Als alternatief kan je ook een URL opgeven zoals ldap://hostname:port/',
	...
	'LDAP_USER_EXPLAIN'				=> 'Laat dit leeg als je gebruikt maakt van gasttoegang. Als het ingevuld is, zal phpBB proberen met de opgegeven LDAP-gebruikersnaam zich aanmelden om vervolgens de correcte gebruiker te vinden, bijvoorbeeld; <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. Wat nodig is voor Aktieve Directory Servers.',
	'LDAP_USER_FILTER'				=> 'LDAP-gebruikersfilter',
	'LDAP_USER_FILTER_EXPLAIN'		=> 'Optioneel kan je de verdere gezochten objecten beperken met bijkomende filters. Bijvoorbeeld: <samp>objectClass=posixGroup</samp> wat zal resulteren in het gebruik van <samp>(&amp;(uid=$username)(objectClass=posixGroup))</samp>',
));

// Server Settings
$lang = array_merge($lang, array(
	'ACP_SERVER_SETTINGS_EXPLAIN'	=> 'Hier kan je de server en domein gerelateerde instellingen opgeven. Zorg ervoor dat de data die je invoert correct is, fouten zullen dan resulteren in foutieve informatie in e-mailberichten. Wanneer je de domeinnaam invoert, vergeet niet dat het de http:// of een andere protocol term bijvoegd. Voer alleen een ander poortnummer in als je zeker weet dat jouw server een andere waarde gebruikt, poort 80 is in de meeste gevallen de correcte poort.',
	...
	'FORCE_SERVER_VARS_EXPLAIN'	=> 'Wanneer je dit instelt op ja, worden de vooraf opgegeven waarden gebruikt, in plaats van de automatische herkenden waarden.',
	'ICONS_PATH'				=> 'Berichtpictogrammen-opslagpad',
	'ICONS_PATH_EXPLAIN'		=> 'Het pad onder je phpBB-hoofddirectory, bijvoorbeeld; <samp>images/icons</samp>.',
	'PATH_SETTINGS'				=> 'Pad-instellingen',
	'RANKS_PATH'				=> 'Rangafbeeldingen-opslagpad',
	'RANKS_PATH_EXPLAIN'		=> 'Het pad onder je phpBB-hoofddirectory, bijvoorbeeld; <samp>images/ranks</samp>.',
	...
	'SERVER_PORT_EXPLAIN'		=> 'De poort waarop je server draait, normaal gesproken 80, verander het alleen als het anders moet zijn.',
	...
	'SMILIES_PATH_EXPLAIN'		=> 'Het pad onder je phpBB-hoofddirectory, bijvoorbeeld; <samp>images/smilies</samp>.',
	'UPLOAD_ICONS_PATH'			=> 'Extensie-groepspictogrammen-opslagpad',
	'UPLOAD_ICONS_PATH_EXPLAIN'	=> 'Het pad onder je phpBB-hoofddirectory, bijvoorbeeld; <samp>images/upload_icons</samp>.',
));

// Security Settings
$lang = array_merge($lang, array(
	'ACP_SECURITY_SETTINGS_EXPLAIN'		=> 'Hier kan je alle sessie en aanmeldings gerelateerde instellingen instellen.',
	...
	'FORM_TIME_MAX_EXPLAIN'			=> 'De tijd die een gebruiker heeft om een formulier te versturen. Gebruik -1 om deze optie uit te schakelen. Vergeet niet dat het mogelijk is dat een formulier ongeldig word zodra de sessie is verlopen, het maakt dan niet uit hoe je deze instelling ook instelt.',
	...
	'FORWARDED_FOR_VALID_EXPLAIN'	=> 'Sessies worden alleen hervat wanneer de verzonden <var>X_FORWARDED_FOR</var>-header gelijk is aan de vorige verzonden aanvraag. Verbanningen zullen ook worden gecontroleerd met de IPs in de <var>X_FORWARDED_FOR</var>.',
	'IP_VALID'						=> 'IP-sessie controleren',
	'IP_VALID_EXPLAIN'				=> 'Dit bepaald welk deel van het IP van de gebruikers worden gecontroleerd voor de sessiecontrole; <samp>Alle</samp> vergelijkt het volledige adres, <samp>A.B.C</samp> de eerste x.x.x, <samp>A.B</samp> de eerste x.x, <samp>Geen</samp> schakelt de controle uit. Op een IPv6-adres <samp>A.B.C</samp> worden de eerste 4 blokken en <samp>A.B</samp> de eerste 3 blokken vergeleken.',
...
// Email Settings
$lang = array_merge($lang, array(
	'ACP_EMAIL_SETTINGS_EXPLAIN'	=> 'Deze informatie wordt gebruikt wanneer het forum e-mails verstuurd naar je gebruikers. Wees er zeker van het het e-mailadres dat je hebt opgegeven geldig is, alle geweigerde, berichten die niet bezorgt kunnen worden zullen worden verstuurd naar dat adres. Als je host niet voorzien is van een oorspronkelijke (PHP gebaseerde) e-mailservice, kan je direct berichten versturen door het gebruiken van SMTP. Dit vereist wel het adres van een juiste server (vraag je provider mocht het nodig zijn). Als server authenticatie vereist (en alleen als het echt zo is) geeft je de juiste gebruikersnaam, wachtwoord en authenticatie-methode op.',
	...
	'BOARD_EMAIL_FORM_EXPLAIN'		=> 'Inplaats van dat de e-mailadressen van gebruikers worden weergegeven, kunnen gebruikers elkaar e-mails versturen via het forum.',
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Als deze optie is uitgeschakeld kunnen er geen e-mails worden verzonden door het forum. <em>Bij de gebruiker en beheerder account-activatieinstellingen zal deze instelling verplicht ingeschakeld moeten zijn. Als je momenteel de “gebruiker” of “beheerder” activatie gebruikt in de activatieinstellingen, en je schakelt deze instelling uit, dan hebben nieuwe accounts geen activatie nodig.</em>',
	'SMTP_AUTH_METHOD'				=> 'Authenticatie-methode voor SMTP',
	'SMTP_AUTH_METHOD_EXPLAIN'		=> 'Alleen gebruiken als een gebruikersnaam/wachtwoord is ingesteld, vraag aan je provider als je niet zeker weet welke methode je moet gebruiken.',
	'SMTP_CRAM_MD5'					=> 'CRAM-MD5',
	'SMTP_DIGEST_MD5'				=> 'DIGEST-MD5',
	'SMTP_LOGIN'					=> 'AANMELDEN',
	'SMTP_PASSWORD'					=> 'SMTP-wachtwoord',
	'SMTP_PASSWORD_EXPLAIN'			=> 'Alleen een wachtwoord opgeven als je SMTP-server er om vraagt.<br /><em><strong>Waarschuwing:</strong> Dit wachtwoord wordt opgeslagen als normale tekst in de database, en is zichtbaar voor iedereen die toegang heeft tot de database of wie deze configuratiepagina kan bekijken.</em>',
	'SMTP_PLAIN'					=> 'NORMAAL',
	'SMTP_POP_BEFORE_SMTP'			=> 'POP-VOOR-SMTP',
	'SMTP_PORT'						=> 'SMTP-serverpoort',
	'SMTP_PORT_EXPLAIN'				=> 'Verander het alleen als je weet dat de SMTP-server zich bevindt op een andere poort.',
	'SMTP_SERVER'					=> 'SMTP-serveradres',
	'SMTP_SETTINGS'					=> 'SMTP-instellingen',
	'SMTP_USERNAME'					=> 'SMTP-gebruikersnaam',
	'SMTP_USERNAME_EXPLAIN'			=> 'Alleen een gebruikersnaam opgeven als je SMTP-server er om vraagt.',
	'USE_SMTP'						=> 'SMTP-server voor e-mail gebruiken',
	'USE_SMTP_EXPLAIN'				=> 'Selecteer “Ja” als je wilt dat e-mails worden verzonden via een naamserver, inplaats van de lokale mail-functie.',
));

// Jabber settings
$lang = array_merge($lang, array(
	'ACP_JABBER_SETTINGS_EXPLAIN'	=> 'Hier kan je Jabber beheren en inschakelen voor het gebruik van instant messaging en forum-notificaties. Jabber is een open source protocol en daardoor voor iedereen beschikbaar. Sommige Jabber-servers inclusief gateways of transports wat ervoor zorgt dat je contact kan leggen met gebruikers op andere netwerken. Niet alle servers bieden transport en wijzigingen in protocols wat er voor kan zorgen dan de transport niet goed werkt. Hou in de gaten dat je bestaande geregistreerde accountgegevens moet opgeven - phpBB zal gebruik maken van de gegevens die je hier opgeeft.',
	...
	'JAB_PACKAGE_SIZE_EXPLAIN'	=> 'Dit is het aantal berichten dat in één pakket wordt verstuurd. Als je dit instelt op 0 zal het bericht meteen worden verzonden en zal het niet in de wachtrij worden geplaatst voor latere verzending.',
	...
	'JAB_PORT_EXPLAIN'			=> 'Leeg laten tenzij je weet dat het niet poort 5222 is.',
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Geef een geregistreerde gebruikersnaam of een geldige JID op. De gebruikersnaam zal niet worden gecontroleerd op geldigheid. Als je alleen een gebruikersnaam opgeeft dan zal jouw JID de gebruikersnaam worden en de server die je hierboven hebt opgegeven. Anders voer je een geldig JID in, bijvoorbeeld : gebruiker@jabber.org.',
));

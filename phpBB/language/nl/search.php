...
$lang = array_merge($lang, array(
	...
	'IGNORED_TERMS_EXPLAIN'	=> 'De volgende woorden van je zoekopdracht zijn genegeerd omdat het te vaak voorkomende woorden zijn: <strong>%s</strong>.',

	'JUMP_TO_POST'			=> 'Ga naar bericht',

    'LOGIN_EXPLAIN_EGOSEARCH'		=> 'Het forum vereist dat je geregistreerd en aangemeld bent om je eigen berichten te kunnen bekijken.',
	'LOGIN_EXPLAIN_UNREADSEARCH'	=> 'Het forum vereist dat je geregistreerd en aangemeld bent om jouw ongelezen berichten te kunnen bekijken.',
	'LOGIN_EXPLAIN_NEWPOSTS'		=> 'Het forum vereist dat je geregistreerd en aangemeld bent om nieuwe berichten te kunnen bekijken sinds je laatste bezoek.',	

	'MAX_NUM_SEARCH_KEYWORDS_REFINE'	=> 'Je hebt teveel woorden opgeven voor je zoekopdracht. Voer niet meer dan %1$d woorden in.',

	'NO_KEYWORDS'			=> 'Je moet tenminste één woord opgeven om op te kunnen zoeken. Elk woord moet tenminste %d tekens bevatten en mag niet meer dan %d tekens zijn exclusief jokertekens.',
	'NO_RECENT_SEARCHES'	=> 'Er zijn recent geen zoekopdrachten uitgevoerd.',
	'NO_SEARCH'				=> 'Sorry, maar je hebt geen toestemming om de zoekfunctie te gebruiken.',
	'NO_SEARCH_RESULTS'		=> 'Er zijn geen resultaten gevonden die overeenkomen met je zoekopdracht.',
	'NO_SEARCH_TIME'		=> 'Sorry, je kan op dit moment niet de zoekfunctie gebruiken. Probeer het over een paar minuten opnieuw.',
	...
	'SEARCH_FORUMS_EXPLAIN'		=> 'Selecteer het forum of forums waar je wenst in te gaan zoeken. Subforums worden automatisch doorzocht als je de functie “subforums doorzoeken” niet uitschakeld hieronder.',
	'SEARCH_IN_RESULTS'			=> 'Deze resultaten doorzoeken',
	'SEARCH_KEYWORDS_EXPLAIN'	=> 'Plaats <strong>+</strong> voor een woord welke gevonden moet worden en plaats <strong>-</strong> voor een woord welke niet gevonden moet worden. Je kan een lijst van woorden verdelen doormiddel van <strong>|</strong> tussen de haakjes te plaatsen als één van de woorden gevonden moet worden. Gebruik een jokerteken (*) voor gedeeltelijke overeenkomsten.',
	...
	'TOO_FEW_AUTHOR_CHARS'	    => 'Je moet tenminste %d tekens invoeren van de auteursnaam.',
));

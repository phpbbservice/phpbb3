...
*
* @package language
* @version $Id: memberlist.php 267 2010-01-31 16:12:05Z Raimon $
...
$lang = array_merge($lang, array(
    ...
    'EMAIL_BODY_EXPLAIN'	=> 'Dit bericht zal worden verzonden als normale tekst, gebruik geen HTML of BBCode. Het antwoordadres voor dit bericht zal worden ingesteld als jouw e-mailadres.',
	'EMAIL_DISABLED'		=> 'Sorry, maar alle e-mail gerelateerde functies zijn uitgeschakeld.',
	'EMAIL_SENT'			=> 'De e-mail is verzonden.',
	'EMAIL_TOPIC_EXPLAIN'	=> 'Dit bericht zal worden verzonden als normale tekst, gebruik geen HTML of BBCode. Vergeet niet dat de onderwerpinformatie al is bijgevoegd in het bericht. Het antwoordadres voor dit bericht zal worden ingesteld als jouw e-mailadres.',
	'EMPTY_ADDRESS_EMAIL'	=> 'Je moet een geldig e-mailadres van de ontvanger invoeren.',
	'EMPTY_MESSAGE_EMAIL'	=> 'Het e-mailbericht moet tekst bevatten.',
	'EMPTY_MESSAGE_IM'		=> 'Je moet een bericht invoeren dat verzonden moet worden.',
	'EMPTY_NAME_EMAIL'		=> 'Je moet de echte naam van de ontvanger invoeren.',
	'EMPTY_SUBJECT_EMAIL'	=> 'Je moet een titel invoeren voor het e-mailbericht.',
	'EQUAL_TO'				=> 'Gelijk aan',

	'FIND_USERNAME_EXPLAIN'	=> 'Gebruik dit formulier om te zoeken naar specifieke gebruikers. Je hoeft niet alle velden in te vullen. Voor een overeenkomst met gedeeltelijke gegevens kan je het * (jokerteken) gebruiken. Wanneer je datums invoert gebruik dan het formaat <kbd>YYYY-MM-DD</kbd>, bijv <samp>2004-02-29</samp>. Gebruik de markeervakken om één of meerdere gebruikersname (diverse gebruikersnamen kunnen geaccepteerd worden afhankelijk van het formulier) en klik op de gemarkeerde selecteer knop om terug te keren naar het vorige formulier.',
	'FLOOD_EMAIL_LIMIT'		=> 'Je kan niet een andere e-mail op dit moment versturen. Probeer het over een aantal minuten nog eens.',
	...
	'IM_AIM'				=> 'Vergeet niet dat je AOL Instant Messenger moet hebben geïnstalleerd, om dit te kunnen gebruiken.',
	...
	'IM_MSNM'				=> 'Vergeet niet dat je Windows ( Live ) Messenger moet hebben geïnstalleerd, om dit te kunnen gebruiken.',
	'IM_MSNM_BROWSER'		=> 'Je internetbrowser ondersteunt dit niet.',
	'IM_MSNM_CONNECT'		=> 'MSNM is niet verbonden.\nJe moet verbinding hebben met MSNM om verder te gaan.',
	'IM_NAME'				=> 'Je naam',
	'IM_NO_DATA'			=> 'Er is geen geschikte contactinformatie gevonden voor deze gebruiker.',
  	'IM_NO_JABBER'			=> 'Sorry, direct versturen van berichten naar jabber-gebruikers wordt niet ondersteund door dit forum. Je hebt een Jabber-client nodig dat is geïnstalleerd op jouw computer om contact op te nemen met de ontvanger.',
	'IM_RECIPIENT'			=> 'Ontvanger',
	'IM_SEND'				=> 'Bericht versturen',
	'IM_SEND_MESSAGE'		=> 'Bericht versturen',
	'IM_SENT_JABBER'		=> 'Je bericht naar %1$s is succesvol verzonden.',
	...
	'LOGIN_EXPLAIN_MEMBERLIST'	=> 'Het forum vereist dat je geregistreerd en aangemeld bent om de ledenlijst te kunnen bekijken.',
	'LOGIN_EXPLAIN_SEARCHUSER'	=> 'Het forum vereist dat je geregistreerd en aangemeld bent om naar gebruikers te zoeken.',
	'LOGIN_EXPLAIN_VIEWPROFILE'	=> 'Het forum vereist dat je geregistreerd en aangemeld bent om profielen te bekijken.',

	'MORE_THAN'				=> 'Meer dan',

	'NO_EMAIL'				=> 'Je hebt geen toestemming om deze gebruiker een e-mail te sturen.',
	'NO_VIEW_USERS'			=> 'Je hebt niet de permissies om de gebruikerslijst of profielen te bekijken.',

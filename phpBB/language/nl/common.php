...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_DEACTIVATED'			=> 'Je account is handmatig gedeactiveerd en kan alleen door een beheerder weer worden geactiveerd.',
	'ACCOUNT_NOT_ACTIVATED'			=> 'Je account is nog niet geactiveerd.',
	'ACP'							=> 'Beheerderspaneel',
	'ACTIVE'						=> 'actief',
	'ACTIVE_ERROR'					=> 'De opgegeven gebruikersnaam is momenteel inactief. Als je problemen hebt met het activeren van jouw account, neem dan contact op met de beheerder van dit forum.',
	...
	'AND'							=> 'En',
	'ARE_WATCHING_FORUM'			=> 'Je bent geabonneerd om e-mailberichten te ontvangen wanneer er nieuwe berichten zijn in dit forum.',
	'ARE_WATCHING_TOPIC'			=> 'Je bent geabonneerd  om e-mailberichten te ontvangen wanneer er nieuwe berichten zijn in dit onderwerp.',
	'ASCENDING'						=> 'Oplopend',
	'ATTACHMENTS'					=> 'Bijlagen',
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'Het afbeeldingsbestand dat je als bijlage probeerde toe te voegen is ongeldig.',
	'AUTHOR'						=> 'Auteur',
	...
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'	=> 'De opgegeven avatar kon niet worden geupload doordat tijdens het verzoek een time-out is opgetreden.',
	'AVATAR_URL_INVALID'            => 'De opgegeven URL is ongeldig.',
	'AVATAR_URL_NOT_FOUND'          => 'Het opgegeven bestand kan niet worden gevonden.',
	'AVATAR_WRONG_FILESIZE'         => 'De bestandsgrootte van de avatar moet tussen de 0 en %1$d %2$s zijn.',
	...
	'BAN_TRIGGERED_BY_EMAIL'=> 'Een verbanning is gegeven op jouw e-mailadres.',
	'BAN_TRIGGERED_BY_IP'   => 'Een verbanning is gegeven op jouw IP-adres.',
	'BAN_TRIGGERED_BY_USER' => 'Een verbanning is gegeven op jouw gebruikersnaam.',
	'BBCODE_GUIDE'          => 'BBCode handleiding',
	'BCC'                   => 'BCC',
	'BIRTHDAYS'             => 'Verjaardagen',
	'BOARD_BAN_PERM'        => 'Je bent <strong>permanent</strong> verbannen van dit forum.<br /><br />Neem contact op met de %2$sforumbeheerder%3$s voor meer informatie.',
	'BOARD_BAN_REASON'      => 'Reden voor verbanning: <strong>%s</strong>',
	'BOARD_BAN_TIME'        => 'Je bent verbannen van dit forum tot <strong>%1$s</strong>.<br /><br />Neem contact op met de %2$sforumbeheerder%3$s voor meer informatie.',
	...
	'CONFIRM_CODE_WRONG'	=> 'De bevestigingscode die je hebt ingevoerd is onjuist',
	...
	'EMPTY_SUBJECT'						=> 'Je moet een onderwerptitel invoeren voordat je een nieuw onderwerp kan plaatsen.',
	'EMPTY_MESSAGE_SUBJECT'				=> 'Je moet een onderwerptitel invoeren voordat je een nieuw bericht kan plaatsen.',
	...
	'ERR_UNWATCHING'					=> 'Er is een fout opgetreden terwijl je het abonnement aan het stopzetten was.',
	'ERR_WATCHING'						=> 'Er is een fout opgetreden terwijl je aan het abonneren was.',
	...
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'FTP-server die gebruikt wordt om verbinding te maken met je site.',
	'FTP_FSOCK_PASSWORD'			=> 'FTP-wachtwoord',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> 'Wachtwoord van je FTP-gebruikersnaam.',
	'FTP_FSOCK_PORT'				=> 'FTP-poort',
	'FTP_FSOCK_PORT_EXPLAIN'		=> 'Poort die gebruikt wordt om verbinding te maken met je server.',
	'FTP_FSOCK_ROOT_PATH'			=> 'Pad naar phpBB',
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Pad van de hoofdmap naar je phpBB forum.',
	...
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'Gebruikersnaam die gebruikt wordt om verbinding te maken met je server.',

	'FTP_HOST'					=> 'FTP-host',
	'FTP_HOST_EXPLAIN'			=> 'FTP-server die gebruikt wordt om verbinding te maken met je site.',
	'FTP_PASSWORD'				=> 'FTP-wachtwoord',
	'FTP_PASSWORD_EXPLAIN'		=> 'Wachtwoord van je FTP-gebruikersnaam.',
	'FTP_PORT'					=> 'FTP-poort',
	'FTP_PORT_EXPLAIN'			=> 'Poort die gebruikt wordt om verbinding te maken met je server.',
	'FTP_ROOT_PATH'				=> 'Pad naar phpBB',
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Pad van de hoofdmap naar je phpBB forum.',
	...
	'FTP_USERNAME_EXPLAIN'		=> 'Gebruikersnaam die gebruikt wordt om verbinding te maken met je server.',
	...
	'IP'						=> 'IP-adres',
	'IP_BLACKLISTED'			=> 'Jouw IP-adres %1$s is geblokeerd omdat het op de zwarte lijst voorkomt. Voor details bekijk je de volgende link <a href="%2$s">%2$s</a>.',

	'JABBER'				=> 'Jabber',
	'JOINED'				=> 'Geregistreerd',
	'JUMP_PAGE'				=> 'Voer het nummer in van de pagina waar je naartoe wilt gaan',
	'JUMP_TO'				=> 'Ga naar',
	...
	'LOGIN'								=> 'Aanmelden',
	'LOGIN_CHECK_PM'					=> 'Meld je aan om je privéberichten te lezen.',
	'LOGIN_CONFIRMATION'				=> 'Bevestiging van aanmelding',
	'LOGIN_CONFIRM_EXPLAIN'				=> 'Om aanvallen op accounts te voorkomen, moet je een bevestigingscode invoeren na een maximaal aantal mislukte aanmeldingspogingen. De code is weergegeven in de afbeelding die je hieronder kan zien. Wanneer je visueel gehandicapt bent, of je kan de code niet lezen neem dan contact op met de %sforumbeheerder%s.',  // taalvariabele wordt niet gebruikt 
	'LOGIN_ERROR_ATTEMPTS'				=> 'Je hebt het maximaal aantal toegestane aanmeldingspogingen bereikt. Naast je gebruikersnaam en wachtwoord moet je nu ook de CAPTCHA oplossen die hieronder is weergegeven.',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'Je bent niet geautoriseerd door Apache.',
	'LOGIN_ERROR_PASSWORD'				=> 'Je hebt een ongeldig wachtwoord opgegeven. Controleer je wachtwoord en probeer het nog eens. Neem contact op met de %sforumbeheerder%s wanneer dit probleem zich blijft voordoen.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'Het was niet mogelijk om je wachtwoord mee te converteren toen deze forumsoftware was geüpdate. Vraag %seen nieuw wachtwoord%s aan. Als je nog steeds problemen ondervindt, neem dan contact op met de %sforumbeheerder%s.',
	'LOGIN_ERROR_USERNAME'				=> 'Je hebt een ongeldige gebruikersnaam opgegeven. Controleer je gebruikersnaam en probeer het nog eens. Neem contact op met de %sforumbeheerder%s wanneer dit probleem zich blijft voordoen.',
	'LOGIN_FORUM'						=> 'Om dit forum te kunnen bekijken of er berichten in te kunnen plaatsen, moet je het wachtwoord wat voor dit forum geldt opgeven.',
	'LOGIN_INFO'						=> 'Om je te kunnen aanmelden moet je eerst geregisteerd zijn. Registeren neemt alleen een paar secondes in beslag, maar het geeft je veel meer mogelijkheden. Het is mogelijk dat de forumbeheerder extra permissies geeft aan geregistreerde gebruikers. Voordat je gaat registeren, wees er dan zeker van dat je bekend wordt met onze gebruikersvoorwaarden en de andere relaterende voorwaarden. Wees er ook zeker van dat je de forumregels doorleest wanneer je dit forum doorzoekt.',
	'LOGIN_VIEWFORUM'					=> 'Om dit forum te kunnen bekijken moet je geregistreerd en aangemeld zijn.',
	'LOGIN_EXPLAIN_EDIT'				=> 'Om berichten te kunnen wijzigen in dit forum moet je geregistreerd en aangemeld zijn.',
	'LOGIN_EXPLAIN_VIEWONLINE'			=> 'Om de wie is er online lijst te kunnen bekijken moet je geregistreerd en aangemeld zijn.',
	'LOGOUT'							=> 'Afmelden',
	...
	'MODULE_NOT_ACCESS'		=> 'Module is niet toegankelijk.',
	'MODULE_NOT_FIND'		=> 'Kan de module %s niet vinden.',
	'MODULE_FILE_INCORRECT_CLASS'	=> 'Het modulebestand %s bevat niet de juiste class [%s]',
	'MONTH'					=> 'Maand',
	'MOVE'					=> 'Verplaatsen',
	'MSNM'					=> 'MSNM/WLM',
	...
	'NEVER'						=> 'Nooit',
	'NO'						=> 'Nee',
	'NOT_ALLOWED_MANAGE_GROUP'	=> 'Je bent niet bevoegd om deze groep te beheren.',
	'NOT_AUTHORISED'			=> 'Je bent niet bevoegd om deze sectie te bekijken.',
	'NOT_WATCHING_FORUM'		=> 'Je bent niet langer geabonneerd voor updates van dit forum.',
	'NOT_WATCHING_TOPIC'		=> 'Je bent niet langer geabonneerd voor dit onderwerp.',
	...
	'NO_ACCESS_ATTACHMENT'		=> 'Je bent niet bevoegd om dit bestand te openen.',
	'NO_ACTION'					=> 'Er is geen actie opgegeven.',
	'NO_ADMINISTRATORS'			=> 'Er zijn geen beheerders.',
	'NO_AUTH_ADMIN'				=> 'Toegang tot het beheerderspaneel is niet toegestaan, omdat je geen beheerderspermissies hebt.',
	'NO_AUTH_ADMIN_USER_DIFFER'	=> 'Je kan je niet opnieuw aanmelden als een andere gebruiker.',
	'NO_AUTH_OPERATION'			=> 'Je hebt niet de benodigde permissies om deze operatie te voltooien.',
	...
	'NO_FORUM'					=> 'Het forum wat je geselecteerd hebt bestaat niet.',
	...
	'POST_BY_AUTHOR'			=> 'door',
	'POST_BY_FOE'				=> 'Dit bericht is geschreven door <strong>%1$s</strong>, maar deze gebruiker staat op je vijandenlijst. %2$sDit bericht weergeven%3$s.',
	...
	'REMOVE'					=> 'Verwijderen',
	'REMOVE_INSTALL'			=> 'Verwijder, verplaats of hernoem de install-directory voordat je dit forum gaat gebruiken. Als deze directory nog steeds aanwezig is, dan zal alleen het beheerderspaneel toegankelijk zijn.',
	'REPLIES'					=> 'Reacties',
	...
	'RULES_ATTACH_CAN'			=> 'Je <strong>mag</strong> bijlagen plaatsen in dit forum',
	'RULES_ATTACH_CANNOT'		=> 'Je <strong>mag geen</strong> bijlagen plaatsen in dit forum',
	'RULES_DELETE_CAN'			=> 'Je <strong>mag</strong> je berichten verwijderen in dit forum',
	'RULES_DELETE_CANNOT'		=> 'Je <strong>mag</strong> je berichten <strong>niet</strong> verwijderen in dit forum',
	'RULES_DOWNLOAD_CAN'		=> 'Je <strong>mag</strong> bijlagen downloaden in dit forum',
	'RULES_DOWNLOAD_CANNOT'		=> 'Je <strong>mag geen</strong> bijlagen downloaden in dit forum',
	'RULES_EDIT_CAN'			=> 'Je <strong>mag</strong> je berichten wijzigen in dit forum',
	'RULES_EDIT_CANNOT'			=> 'Je <strong>mag</strong> je berichten <strong>niet</strong> wijzigen in dit forum',
	'RULES_LOCK_CAN'			=> 'Je <strong>mag</strong> je eigen onderwerpen sluiten in dit forum',
	'RULES_LOCK_CANNOT'			=> 'Je <strong>mag</strong> je eigen onderwerpen <strong>niet</strong> sluiten in dit forum',
	'RULES_POST_CAN'			=> 'Je <strong>mag</strong> nieuwe onderwerpen plaatsen in dit forum',
	'RULES_POST_CANNOT'			=> 'Je <strong>mag geen</strong> nieuwe onderwerpen plaatsen in dit forum',
	'RULES_REPLY_CAN'			=> 'Je <strong>mag</strong> reacties plaatsen op onderwerpen in dit forum',
	'RULES_REPLY_CANNOT'		=> 'Je <strong>mag geen</strong> reacties plaatsen op onderwerpen in dit forum',
	'RULES_VOTE_CAN'			=> 'Je <strong>mag</strong> stemmen in peilingen in dit forum',
	'RULES_VOTE_CANNOT'			=> 'Je <strong>mag niet</strong> stemmen in peilingen in dit forum',
	...
	'SORRY_AUTH_READ'			=> 'Je bent niet bevoegd om dit forum te lezen.',
	'SORRY_AUTH_VIEW_ATTACH'	=> 'Je bent niet bevoegd om deze bijlage te downloaden.',
	'SORT_BY'					=> 'Sorteer op',
	...
	'TOO_LARGE'                => 'De waarde die je hebt opgegeven is te lang.',
	'TOO_LARGE_MAX_RECIPIENTS' => 'De waarde van de <strong>maximaal aantal toegestane ontvangers per privébericht</strong> instelling die je hebt opgegeven is te lang.',

	'TOO_LONG'						=> 'De waarde die je hebt ingevoerd is te lang.',

	'TOO_LONG_AIM'					=> 'De schermnaam die je hebt ingevoerd is te lang.',
	'TOO_LONG_CONFIRM_CODE'			=> 'De bevestigingscode die je hebt ingevoerd is te lang.',
	'TOO_LONG_DATEFORMAT'			=> 'Het datumformaat dat je hebt ingevoerd is te lang.',
	'TOO_LONG_ICQ'					=> 'Het ICQ-nummer dat je hebt ingevoerd is te lang.',
	'TOO_LONG_INTERESTS'			=> 'De interesses die je hebt ingevoerd zijn te lang.',
	'TOO_LONG_JABBER'				=> 'De Jabber-accountnaam dat je hebt ingevoerd is te lang.',
	'TOO_LONG_LOCATION'				=> 'De woonplaats die je hebt ingevoerd is te lang.',
	'TOO_LONG_MSN'					=> 'De MSNM/WLM-naam die je hebt ingevoerd is te lang.',
	'TOO_LONG_NEW_PASSWORD'			=> 'Het wachtwoord dat je hebt ingevoerd is te lang.',
	'TOO_LONG_OCCUPATION'			=> 'Het beroep dat je hebt ingevoerd is te lang.',
	'TOO_LONG_PASSWORD_CONFIRM'		=> 'De bevestiging van het wachtwoord dat je hebt ingevoerd is te lang.',
	'TOO_LONG_USER_PASSWORD'		=> 'Het wachtwoord dat je hebt ingevoerd is te lang.',
	'TOO_LONG_USERNAME'				=> 'De gebruikersnaam die je hebt ingevoerd is te lang.',
	'TOO_LONG_EMAIL'				=> 'Het e-mailadres dat je hebt ingevoerd is te lang.',
	'TOO_LONG_EMAIL_CONFIRM'		=> 'De bevestiging van je e-mailadres dat je hebt ingevoerd is te lang.',
	'TOO_LONG_WEBSITE'				=> 'Het website-adres dat je hebt ingevoerd is te lang.',
	'TOO_LONG_YIM'					=> 'De Yahoo! Messenger-gebruikersnaam die je hebt ingevoerd is te lang.',

	'TOO_MANY_VOTE_OPTIONS'			=> 'Je hebt geprobeerd om op teveel opties te stemmen.',

	'TOO_SHORT'						=> 'De waarde die je hebt ingevoerd is te kort.',

	'TOO_SHORT_AIM'					=> 'De schermnaam die je hebt ingevoerd is te kort.',
	'TOO_SHORT_CONFIRM_CODE'		=> 'De bevestigingscode die je hebt ingevoerd is te kort.',
	'TOO_SHORT_DATEFORMAT'			=> 'Het datumformaat dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_ICQ'					=> 'Het ICQ-nummer dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_INTERESTS'			=> 'De interesses die je hebt ingevoerd zijn te kort.',
	'TOO_SHORT_JABBER'				=> 'De Jabber-accountnaam die je hebt ingevoerd is te kort.',
	'TOO_SHORT_LOCATION'			=> 'De woonplaats die je hebt ingevoerd is te kort.',
	'TOO_SHORT_MSN'					=> 'De MSNM/WLM-naam die je hebt ingevoerd is te kort.',
	'TOO_SHORT_NEW_PASSWORD'		=> 'Het wachtwoord dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_OCCUPATION'			=> 'Het beroep dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_PASSWORD_CONFIRM'	=> 'De bevestiging van het wachtwoord dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_USER_PASSWORD'		=> 'Het wachtwoord dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_USERNAME'			=> 'De gebruikersnaam die je hebt ingevoerd is te kort.',
	'TOO_SHORT_EMAIL'				=> 'Het e-mailadres dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_EMAIL_CONFIRM'		=> 'De bevestiging van je e-mailadres dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_WEBSITE'				=> 'Het website-adres dat je hebt ingevoerd is te kort.',
	'TOO_SHORT_YIM'					=> 'De Yahoo! Messenger-gebruikersnaam die je hebt ingevoerd is te kort.',
	
	'TOO_SMALL'                     => 'De waarde die je hebt opgegeven is te kort.', 
	'TOO_SMALL_MAX_RECIPIENTS'      => 'De waarde van de <strong>maximaal aantal toegestane ontvangers per privébericht</strong> instelling die je hebt opgegeven is te kort.',
	
	'TOPIC'					=> 'Onderwerp',
	'TOPICS'				=> 'Onderwerpen',
	'TOPICS_UNAPPROVED'		=> 'Tenminste één onderwerp in dit forum is nog niet goedgekeurd.',
	'TOPIC_ICON'			=> 'Onderwerppictogram',
	'TOPIC_LOCKED'			=> 'Dit onderwerp is gesloten. Je kunt geen berichten wijzigen of nieuwe reacties plaatsen.',
	...
	'UNWATCH_FORUM_CONFIRM'		=> 'Weet je zeker dat je het abonnement wilt stopzetten van dit forum?',
	'UNWATCH_FORUM_DETAILED'	=> 'Weet je zeker dat je het abonnement van het forum “%s” wilt stopzetten?',
	'UNWATCH_TOPIC_CONFIRM'		=> 'Weet je zeker dat je het abonnement wilt stopzetten van dit onderwerp?',
	'UNWATCH_TOPIC_DETAILED'	=> 'Weet je zeker dat je het abonnement van het onderwerp “%s” wilt stopzetten?',	
	'UNWATCHED_FORUMS'			=> 'Je bent niet meer geabonneerd op de geselecteerde forums.',
	'UNWATCHED_TOPICS'			=> 'Je bent niet meer geabonneerd op de geselecteerde onderwerpen.',
	'UNWATCHED_FORUMS_TOPICS'	=> 'Je bent niet meer geabonneerd op de geselecteerde forums en onderwerpen.',
	'UPDATE'					=> 'Update',
	'UPLOAD_IN_PROGRESS'		=> 'Het uploadproces is momenteel aan de gang.',
	'URL_REDIRECT'				=> 'Als je internetbrowser geen meta-redirectie ondersteunt %sklik dan hier om gelijk doorverwezen te worden%s.',
	'USERGROUPS'				=> 'Groepen',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Het spijt ons, maar je bent niet bevoegd om deze functie te gebruiken. Je bent net geregistreerd hier en/of je moet meer deelnemen aan het forum om deze functie te kunnen gebruiken.',
	...
	'WRONG_PASSWORD'	=> 'Je hebt een onjuist wachtwoord ingevoerd.',

	'WRONG_DATA_ICQ'			=> 'Het nummer dat je hebt ingevoerd is een niet geldig ICQ-nummer.',
	'WRONG_DATA_JABBER'			=> 'De naam die je hebt ingevoerd is een niet geldige Jabber-accountnaam.',
	'WRONG_DATA_LANG'			=> 'De taal die je hebt opgegeven is niet geldig.',
	...
	'YOU_NEW_PM'		=> 'Er is een nieuw privébericht aanwezig in je Postvak IN.',
	'YOU_NEW_PMS'		=> 'Er zijn meerdere nieuwe privéberichten aanwezig in je Postvak IN.',
